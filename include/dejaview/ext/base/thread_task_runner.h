...
#ifndef INCLUDE_DEJAVIEW_EXT_BASE_THREAD_TASK_RUNNER_H_
#define INCLUDE_DEJAVIEW_EXT_BASE_THREAD_TASK_RUNNER_H_
...
//
class DEJAVIEW_EXPORT_COMPONENT ThreadTaskRunner : public TaskRunner {
 public:
...
#endif  // INCLUDE_DEJAVIEW_EXT_BASE_THREAD_TASK_RUNNER_H_
