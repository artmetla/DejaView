...
#ifndef INCLUDE_DEJAVIEW_TRACE_PROCESSOR_TRACE_BLOB_H_
#define INCLUDE_DEJAVIEW_TRACE_PROCESSOR_TRACE_BLOB_H_
...
class DEJAVIEW_EXPORT_COMPONENT TraceBlob : public RefCounted {
 public:
...
#endif  // INCLUDE_DEJAVIEW_TRACE_PROCESSOR_TRACE_BLOB_H_
