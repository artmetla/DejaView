...
#ifndef INCLUDE_DEJAVIEW_EXT_BASE_CONTAINER_ANNOTATIONS_H_
#define INCLUDE_DEJAVIEW_EXT_BASE_CONTAINER_ANNOTATIONS_H_

#include "dejaview/base/build_config.h"

// Windows ASAN doesn't currently support these annotations.
#if defined(ADDRESS_SANITIZER) && !DEJAVIEW_BUILDFLAG(DEJAVIEW_OS_WIN) && \
...
#endif  // INCLUDE_DEJAVIEW_EXT_BASE_CONTAINER_ANNOTATIONS_H_
