...
CREATE DEJAVIEW VIEW fastrpc_timeline AS
SELECT
  ts,
  LEAD(ts, 1, trace_end())
...
CREATE DEJAVIEW VIEW fastrpc_subsystem_stats AS
SELECT
  subsystem_name,
...
CREATE DEJAVIEW VIEW fastrpc_raw_allocs AS
SELECT
...
CREATE DEJAVIEW VIEW fastrpc_alloc_stats AS
SELECT
  subsystem_name,
...
CREATE DEJAVIEW VIEW android_fastrpc_event AS
SELECT
...
CREATE DEJAVIEW VIEW android_fastrpc_output AS
