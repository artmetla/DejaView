...
#ifndef INCLUDE_DEJAVIEW_EXT_TRACING_CORE_SHARED_MEMORY_ARBITER_H_
#define INCLUDE_DEJAVIEW_EXT_TRACING_CORE_SHARED_MEMORY_ARBITER_H_
...
class DEJAVIEW_EXPORT_COMPONENT SharedMemoryArbiter {
 public:
  ...
  // |TaskRunner|: Task runner for dejaview's main thread, which executes the
...
#endif  // INCLUDE_DEJAVIEW_EXT_TRACING_CORE_SHARED_MEMORY_ARBITER_H_
