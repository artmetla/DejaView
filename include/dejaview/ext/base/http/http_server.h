...
#ifndef INCLUDE_DEJAVIEW_EXT_BASE_HTTP_HTTP_SERVER_H_
#define INCLUDE_DEJAVIEW_EXT_BASE_HTTP_HTTP_SERVER_H_
...
#endif  // INCLUDE_DEJAVIEW_EXT_BASE_HTTP_HTTP_SERVER_H_
