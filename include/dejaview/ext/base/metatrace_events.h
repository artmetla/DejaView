...
#ifndef INCLUDE_DEJAVIEW_EXT_BASE_METATRACE_EVENTS_H_
#define INCLUDE_DEJAVIEW_EXT_BASE_METATRACE_EVENTS_H_
...
#define DEJAVIEW_METATRACE_EVENTS(F) \
  F(EVENT_ZERO_UNUSED), \
...
//
#define DEJAVIEW_METATRACE_COUNTERS(F) \
...
#define DEJAVIEW_METATRACE_IDENTITY(name) name
#define DEJAVIEW_METATRACE_TOSTRING(name) #name

enum Events : uint16_t {
  DEJAVIEW_METATRACE_EVENTS(DEJAVIEW_METATRACE_IDENTITY),
  EVENTS_MAX
};
constexpr char const* kEventNames[] = {
    DEJAVIEW_METATRACE_EVENTS(DEJAVIEW_METATRACE_TOSTRING)};

enum Counters : uint16_t {
  DEJAVIEW_METATRACE_COUNTERS(DEJAVIEW_METATRACE_IDENTITY),
  COUNTERS_MAX
};
constexpr char const* kCounterNames[] = {
    DEJAVIEW_METATRACE_COUNTERS(DEJAVIEW_METATRACE_TOSTRING)};
...
#endif  // INCLUDE_DEJAVIEW_EXT_BASE_METATRACE_EVENTS_H_
