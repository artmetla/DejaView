...
CREATE DEJAVIEW VIEW _startups_with_upid AS
...
CREATE DEJAVIEW TABLE _ttid AS
...
-- Googlers: see go/android-performance-metrics-glossary for details.
CREATE DEJAVIEW TABLE _ttfd AS
...
-- Googlers: see go/android-performance-metrics-glossary for details.
CREATE DEJAVIEW TABLE android_startup_time_to_display(
  -- Startup id.
  startup_id INT,
