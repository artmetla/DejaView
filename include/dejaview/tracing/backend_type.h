...
#ifndef INCLUDE_DEJAVIEW_TRACING_BACKEND_TYPE_H_
#define INCLUDE_DEJAVIEW_TRACING_BACKEND_TYPE_H_
...
enum BackendType : uint32_t {
  ...
  // Connects to a previously-initialized dejaview tracing backend for
...
#endif  // INCLUDE_DEJAVIEW_TRACING_BACKEND_TYPE_H_
