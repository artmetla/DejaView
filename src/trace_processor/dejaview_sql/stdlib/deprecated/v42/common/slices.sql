...
CREATE DEJAVIEW FUNCTION has_parent_slice_with_name(
...
CREATE DEJAVIEW FUNCTION has_descendant_slice_with_name(
...
CREATE DEJAVIEW FUNCTION descendant_slice_end(
...
CREATE DEJAVIEW FUNCTION direct_children_slice(
  -- Id of the parent slice.
  parent_id LONG)
RETURNS TABLE(
  -- Alias for `slice.id`.
...
CREATE DEJAVIEW FUNCTION slice_name_from_id(
...
CREATE DEJAVIEW FUNCTION slice_count(
