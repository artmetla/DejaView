...
CREATE DEJAVIEW FUNCTION time_from_ns(
...
CREATE DEJAVIEW FUNCTION time_from_us(
...
-- representation of time durations in trace processor.
CREATE DEJAVIEW FUNCTION time_from_ms(
...
-- representation of time durations in trace processor.
CREATE DEJAVIEW FUNCTION time_from_s(
...
-- representation of time durations in trace processor.
CREATE DEJAVIEW FUNCTION time_from_min(
...
-- representation of time durations in trace processor.
CREATE DEJAVIEW FUNCTION time_from_hours(
...
-- representation of time durations in trace processor.
CREATE DEJAVIEW FUNCTION time_from_days(
...
-- representation of time durations in trace processor. Provided for
-- consistency with other functions.
CREATE DEJAVIEW FUNCTION time_to_ns(
  -- Time duration in nanoseconds.
  nanos INT
)
-- Time duration in nanoseconds.
...
-- representation of time durations in trace processor.
CREATE DEJAVIEW FUNCTION time_to_us(
-- Time duration in nanoseconds.
  nanos INT
)
-- Time duration in microseconds.
...
-- representation of time durations in trace processor.
CREATE DEJAVIEW FUNCTION time_to_ms(
  -- Time duration in nanoseconds.
  nanos INT
)
-- Time duration in milliseconds.
...
-- representation of time durations in trace processor.
CREATE DEJAVIEW FUNCTION time_to_s(
  -- Time duration in nanoseconds.
  nanos INT
)
-- Time duration in seconds.
...
-- representation of time durations in trace processor.
CREATE DEJAVIEW FUNCTION time_to_min(
  -- Time duration in nanoseconds.
  nanos INT
)
-- Time duration in minutes.
...
-- representation of time durations in trace processor.
CREATE DEJAVIEW FUNCTION time_to_hours(
  -- Time duration in nanoseconds.
  nanos INT
)
-- Time duration in hours.
...
-- representation of time durations in trace processor.
CREATE DEJAVIEW FUNCTION time_to_days(
  -- Time duration in nanoseconds.
  nanos INT
)
-- Time duration in days.
