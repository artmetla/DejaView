...
#ifndef INCLUDE_DEJAVIEW_EXT_TRACING_IPC_PRODUCER_IPC_CLIENT_H_
#define INCLUDE_DEJAVIEW_EXT_TRACING_IPC_PRODUCER_IPC_CLIENT_H_
...
class DEJAVIEW_EXPORT_COMPONENT ProducerIPCClient {
 public:
...
#endif  // INCLUDE_DEJAVIEW_EXT_TRACING_IPC_PRODUCER_IPC_CLIENT_H_
