...
#ifndef INCLUDE_DEJAVIEW_TRACING_INTERNAL_CHECKED_SCOPE_H_
#define INCLUDE_DEJAVIEW_TRACING_INTERNAL_CHECKED_SCOPE_H_
...
// becomes active.
class DEJAVIEW_EXPORT_COMPONENT CheckedScope {
 public:
...
#endif  // INCLUDE_DEJAVIEW_TRACING_INTERNAL_CHECKED_SCOPE_H_
