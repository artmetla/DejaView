...
#ifndef INCLUDE_DEJAVIEW_TRACING_TRACING_POLICY_H_
#define INCLUDE_DEJAVIEW_TRACING_TRACING_POLICY_H_
...
// dejaview thread.
class DEJAVIEW_EXPORT_COMPONENT TracingPolicy {
 public:
...
#endif  // INCLUDE_DEJAVIEW_TRACING_TRACING_POLICY_H_
