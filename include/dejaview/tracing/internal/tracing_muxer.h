...
#ifndef INCLUDE_DEJAVIEW_TRACING_INTERNAL_TRACING_MUXER_H_
#define INCLUDE_DEJAVIEW_TRACING_INTERNAL_TRACING_MUXER_H_
...
// dejaview headers outside of public, this one cannot.
class DEJAVIEW_EXPORT_COMPONENT TracingMuxer {
 public:
...
#endif  // INCLUDE_DEJAVIEW_TRACING_INTERNAL_TRACING_MUXER_H_
