...
#ifndef INCLUDE_DEJAVIEW_TRACING_TRACK_EVENT_STATE_TRACKER_H_
#define INCLUDE_DEJAVIEW_TRACING_TRACK_EVENT_STATE_TRACKER_H_
...
// events.
class DEJAVIEW_EXPORT_COMPONENT TrackEventStateTracker {
 public:
  ...
  struct ParsedTrackEvent {
    explicit ParsedTrackEvent(
        const dejaview::protos::pbzero::TrackEvent::Decoder&);

    // Underlying event.
    const dejaview::protos::pbzero::TrackEvent::Decoder& track_event;
...
#endif  // INCLUDE_DEJAVIEW_TRACING_TRACK_EVENT_STATE_TRACKER_H_
