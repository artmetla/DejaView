...
#ifndef INCLUDE_DEJAVIEW_EXT_TRACE_PROCESSOR_IMPORTERS_MEMORY_TRACKER_GRAPH_PROCESSOR_H_
#define INCLUDE_DEJAVIEW_EXT_TRACE_PROCESSOR_IMPORTERS_MEMORY_TRACKER_GRAPH_PROCESSOR_H_
...
class DEJAVIEW_EXPORT_COMPONENT GraphProcessor {
 public:
...
#endif  // INCLUDE_DEJAVIEW_EXT_TRACE_PROCESSOR_IMPORTERS_MEMORY_TRACKER_GRAPH_PROCESSOR_H_
