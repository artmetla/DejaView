...
#ifndef INCLUDE_DEJAVIEW_EXT_TRACE_PROCESSOR_IMPORTERS_MEMORY_TRACKER_RAW_PROCESS_MEMORY_NODE_H_
#define INCLUDE_DEJAVIEW_EXT_TRACE_PROCESSOR_IMPORTERS_MEMORY_TRACKER_RAW_PROCESS_MEMORY_NODE_H_
...
class DEJAVIEW_EXPORT_COMPONENT RawProcessMemoryNode {
 public:
...
#endif  // INCLUDE_DEJAVIEW_EXT_TRACE_PROCESSOR_IMPORTERS_MEMORY_TRACKER_RAW_PROCESS_MEMORY_NODE_H_
