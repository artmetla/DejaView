...
CREATE DEJAVIEW TABLE android_auto_multiuser_timing(
...
CREATE DEJAVIEW VIEW _android_auto_user_10_total_cpu_time AS
SELECT
...
CREATE DEJAVIEW VIEW _android_auto_user_10_total_memory AS
...
CREATE DEJAVIEW VIEW android_auto_multiuser_timing_with_previous_user_resource_usage(
    -- Start user id
    event_start_user_id STRING,
    -- Start event time
    event_start_time INT,
