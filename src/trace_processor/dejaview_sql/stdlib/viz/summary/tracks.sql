...
CREATE DEJAVIEW TABLE _thread_track_summary_by_utid_and_name AS
SELECT
  utid,
  parent_id,
  name,
...
CREATE DEJAVIEW TABLE _process_track_summary_by_upid_and_parent_id_and_name AS
SELECT
  id,
  parent_id,
  upid,
...
CREATE DEJAVIEW TABLE _uid_track_track_summary_by_uid_and_name AS
SELECT
  uid,
  parent_id,
  name,
