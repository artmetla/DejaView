...
CREATE DEJAVIEW VIEW hwui_processes AS
SELECT
...
CREATE DEJAVIEW VIEW hwui_draw_frame AS
SELECT
...
CREATE DEJAVIEW VIEW hwui_flush_commands AS
SELECT
...
CREATE DEJAVIEW VIEW hwui_prepare_tree AS
SELECT
...
CREATE DEJAVIEW VIEW hwui_gpu_completion AS
SELECT
...
CREATE DEJAVIEW VIEW hwui_ui_record AS
SELECT
...
CREATE DEJAVIEW VIEW hwui_shader_compile AS
SELECT
...
CREATE DEJAVIEW VIEW hwui_cache_hit AS
SELECT
...
CREATE DEJAVIEW VIEW hwui_cache_miss AS
SELECT
...
CREATE DEJAVIEW VIEW hwui_graphics_cpu_mem AS
SELECT
...
CREATE DEJAVIEW VIEW hwui_graphics_gpu_mem AS
SELECT
...
CREATE DEJAVIEW VIEW hwui_texture_mem AS
SELECT
...
CREATE DEJAVIEW VIEW hwui_all_mem AS
SELECT
...
CREATE DEJAVIEW VIEW android_hwui_metric_output AS
