...
#ifndef SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_INTRINSICS_FUNCTIONS_WINDOW_FUNCTIONS_H_
#define SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_INTRINSICS_FUNCTIONS_WINDOW_FUNCTIONS_H_
...
inline base::Status RegisterLastNonNullFunction(DejaViewSqlEngine& engine) {
...
#endif  // SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_INTRINSICS_FUNCTIONS_WINDOW_FUNCTIONS_H_
