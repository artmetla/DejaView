...
class AndroidPerf implements DejaViewPlugin {
  ...
  async onTraceLoad(ctx: Trace): Promise<void> {
    ctx.commands.registerCommand({
      id: 'dev.dejaview.AndroidPerf#BinderSystemServerIncoming',
      name: 'Run query: system_server incoming binder graph',
      callback: () =>
        addQueryResultsTab(ctx, {
          query: `INCLUDE DEJAVIEW MODULE android.binder;
    ...
    ctx.commands.registerCommand({
      id: 'dev.dejaview.AndroidPerf#BinderSystemServerOutgoing',
    ...
    ctx.commands.registerCommand({
      id: 'dev.dejaview.AndroidPerf#MonitorContentionSystemServer',
      name: 'Run query: system_server monitor_contention graph',
      callback: () =>
        addQueryResultsTab(ctx, {
          query: `INCLUDE DEJAVIEW MODULE android.monitor_contention;
    ...
    ctx.commands.registerCommand({
      id: 'dev.dejaview.AndroidPerf#BinderAll',
    ...
    ctx.commands.registerCommand({
      id: 'dev.dejaview.AndroidPerf#ThreadClusterDistribution',
    ...
    ctx.commands.registerCommand({
      id: 'dev.dejaview.AndroidPerf#SchedLatency',
    ...
    ctx.commands.registerCommand({
      id: 'dev.dejaview.AndroidPerf#SchedLatencyInSelectedWindow',
    ...
    ctx.commands.registerCommand({
      id: 'dev.dejaview.AndroidPerf#AppProcessStarts',
    ...
    ctx.commands.registerCommand({
      id: 'dev.dejaview.AndroidPerf#AppIntentStarts',
...
export const plugin: PluginDescriptor = {
  pluginId: 'dev.dejaview.AndroidPerf',
  plugin: AndroidPerf,
};
