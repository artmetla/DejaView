...
void TriggerProducer::OnConnect() {
  DEJAVIEW_DLOG("Producer connected, sending triggers.");
...
void TriggerProducer::SetupDataSource(DataSourceInstanceID,
  ...
  DEJAVIEW_DFATAL("Attempted to SetupDataSource() on commandline producer");
}
void TriggerProducer::StartDataSource(DataSourceInstanceID,
                                      const DataSourceConfig&) {
  DEJAVIEW_DFATAL("Attempted to StartDataSource() on commandline producer");
}
void TriggerProducer::StopDataSource(DataSourceInstanceID) {
  DEJAVIEW_DFATAL("Attempted to StopDataSource() on commandline producer");
}
void TriggerProducer::Flush(FlushRequestID,
                            const DataSourceInstanceID*,
                            size_t,
                            FlushFlags) {
  DEJAVIEW_DFATAL("Attempted to Flush() on commandline producer");
}
