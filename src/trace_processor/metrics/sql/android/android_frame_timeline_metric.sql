...
CREATE DEJAVIEW VIEW splitted_jank_type_timeline AS
...
CREATE DEJAVIEW VIEW android_frame_timeline_metric_per_process AS
WITH frames AS (
  SELECT
    process.upid,
...
CREATE DEJAVIEW VIEW android_frame_timeline_metric_output AS
