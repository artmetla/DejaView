...
#ifndef INCLUDE_DEJAVIEW_EXT_BASE_SYS_TYPES_H_
#define INCLUDE_DEJAVIEW_EXT_BASE_SYS_TYPES_H_
...
#if DEJAVIEW_BUILDFLAG(DEJAVIEW_OS_ANDROID) && !defined(AID_SHELL)
...
#endif  // INCLUDE_DEJAVIEW_EXT_BASE_SYS_TYPES_H_
