...
#ifndef INCLUDE_DEJAVIEW_EXT_BASE_UTILS_H_
#define INCLUDE_DEJAVIEW_EXT_BASE_UTILS_H_
...
#define DEJAVIEW_EINTR(x) (x)
#else
#define DEJAVIEW_EINTR(x)                                   \
  ([&] {                                                    \
...
template <typename Func>
DEJAVIEW_WARN_UNUSED_RESULT OnScopeExitWrapper<Func> OnScopeExit(Func f) {
...
#endif  // INCLUDE_DEJAVIEW_EXT_BASE_UTILS_H_
