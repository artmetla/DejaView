...
#ifndef INCLUDE_DEJAVIEW_EXT_TRACING_IPC_SERVICE_IPC_HOST_H_
#define INCLUDE_DEJAVIEW_EXT_TRACING_IPC_SERVICE_IPC_HOST_H_
...
class DEJAVIEW_EXPORT_COMPONENT ServiceIPCHost {
 public:
...
#endif  // INCLUDE_DEJAVIEW_EXT_TRACING_IPC_SERVICE_IPC_HOST_H_
