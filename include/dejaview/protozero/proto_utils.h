...
#ifndef INCLUDE_DEJAVIEW_PROTOZERO_PROTO_UTILS_H_
#define INCLUDE_DEJAVIEW_PROTOZERO_PROTO_UTILS_H_
...
#define DEJAVIEW_PROTOZERO_CONSTEXPR14_OR_INLINE constexpr
#else
#define DEJAVIEW_PROTOZERO_CONSTEXPR14_OR_INLINE inline
#endif
...
inline const uint8_t* ParseVarInt(const uint8_t* start,
                                  const uint8_t* end,
                                  uint64_t* out_value) {
  return DejaViewPbParseVarInt(start, end, out_value);
}
...
#endif  // INCLUDE_DEJAVIEW_PROTOZERO_PROTO_UTILS_H_
