...
package android.dejaview.producer;
...
public class ProducerActivity extends Activity {
    ...
    public void onResume() {
        ...
        serviceChannel.setDescription("DejaView service");
        ...
        isolatedChannel.setDescription("DejaView isolated service");
        ...
        System.loadLibrary("dejaviewcts_jni");
