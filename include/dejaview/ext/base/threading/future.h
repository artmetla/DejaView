...
#ifndef INCLUDE_DEJAVIEW_EXT_BASE_THREADING_FUTURE_H_
#define INCLUDE_DEJAVIEW_EXT_BASE_THREADING_FUTURE_H_
...
#endif  // INCLUDE_DEJAVIEW_EXT_BASE_THREADING_FUTURE_H_
