...
#ifndef INCLUDE_DEJAVIEW_EXT_TRACE_PROCESSOR_IMPORTERS_MEMORY_TRACKER_GRAPH_H_
#define INCLUDE_DEJAVIEW_EXT_TRACE_PROCESSOR_IMPORTERS_MEMORY_TRACKER_GRAPH_H_
...
class DEJAVIEW_EXPORT_COMPONENT GlobalNodeGraph {
 public:
  class Node;
  class Edge;
  ...
  // the shared space.
  class DEJAVIEW_EXPORT_COMPONENT Process {
   public:
  ...
  class DEJAVIEW_EXPORT_COMPONENT Node {
   public:
    // Auxilary data (a scalar number or a string) about this node each
    // associated with a key.
    struct DEJAVIEW_EXPORT_COMPONENT Entry {
      enum Type {
        kUInt64,
        kString,
      };
  ...
  class DEJAVIEW_EXPORT_COMPONENT Edge {
   public:
  ...
  class DEJAVIEW_EXPORT_COMPONENT PreOrderIterator {
   public:
  ...
  class DEJAVIEW_EXPORT_COMPONENT PostOrderIterator {
   public:
...
#endif  // INCLUDE_DEJAVIEW_EXT_TRACE_PROCESSOR_IMPORTERS_MEMORY_TRACKER_GRAPH_H_
