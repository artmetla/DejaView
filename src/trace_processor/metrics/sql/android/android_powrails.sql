...
CREATE DEJAVIEW VIEW power_rails_counters AS
...
CREATE DEJAVIEW VIEW avg_used_powers AS
SELECT
  name,
  avg_used_power,
  tot_used_power,
...
CREATE DEJAVIEW VIEW power_rails_view AS
...
CREATE DEJAVIEW VIEW android_powrails_output AS
