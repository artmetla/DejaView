...
CREATE DEJAVIEW MACRO _linux_perf_callstacks_for_samples(
...
CREATE DEJAVIEW TABLE _linux_perf_raw_callstacks AS
SELECT *
...
CREATE DEJAVIEW TABLE linux_perf_samples_summary_tree(
