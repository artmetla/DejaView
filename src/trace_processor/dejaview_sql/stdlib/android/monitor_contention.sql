...
CREATE DEJAVIEW FUNCTION android_extract_android_monitor_contention_blocking_thread(
  -- Name of slice
  slice_name STRING
)
-- Blocking thread
...
CREATE DEJAVIEW FUNCTION android_extract_android_monitor_contention_blocking_tid(
  -- Name of slice
  slice_name STRING
)
-- Blocking thread tid
...
CREATE DEJAVIEW FUNCTION android_extract_android_monitor_contention_blocking_method(
  -- Name of slice
  slice_name STRING
)
-- Blocking thread
...
-- types.
CREATE DEJAVIEW FUNCTION android_extract_android_monitor_contention_short_blocking_method(
  -- Name of slice
  slice_name STRING
)
-- Blocking thread
...
CREATE DEJAVIEW FUNCTION android_extract_android_monitor_contention_blocked_method(
  -- Name of slice
  slice_name STRING
)
-- Blocking thread
...
-- types.
CREATE DEJAVIEW FUNCTION android_extract_android_monitor_contention_short_blocked_method(
  -- Name of slice
  slice_name STRING
)
-- Blocking thread
...
CREATE DEJAVIEW FUNCTION android_extract_android_monitor_contention_waiter_count(
  -- Name of slice
  slice_name STRING
)
...
CREATE DEJAVIEW FUNCTION android_extract_android_monitor_contention_blocking_src(
  -- Name of slice
  slice_name STRING
)
-- Blocking thread
...
CREATE DEJAVIEW FUNCTION android_extract_android_monitor_contention_blocked_src(
  -- Name of slice
  slice_name STRING
)
-- Blocking thread
...
CREATE DEJAVIEW TABLE _valid_android_monitor_contention AS
...
CREATE DEJAVIEW TABLE android_monitor_contention(
...
CREATE DEJAVIEW INDEX _android_monitor_contention_blocking_utid_idx
  ON android_monitor_contention (blocking_utid, ts);

CREATE DEJAVIEW INDEX _android_monitor_contention_id_idx
...
CREATE DEJAVIEW TABLE _children AS
...
CREATE DEJAVIEW TABLE _parents AS
...
CREATE DEJAVIEW TABLE _isolated AS
...
CREATE DEJAVIEW TABLE android_monitor_contention_chain(
...
CREATE DEJAVIEW INDEX _android_monitor_contention_chain_idx
...
CREATE DEJAVIEW VIEW _first_blocked_contention
  AS
...
CREATE DEJAVIEW VIEW _blocking_thread_state
AS
...
--
CREATE DEJAVIEW VIEW android_monitor_contention_chain_thread_state_by_txn(
...
--
-- Note that this data is only available for the first waiter on a lock.
CREATE DEJAVIEW VIEW android_monitor_contention_chain_blocked_functions_by_txn(
  -- Slice id of the monitor contention.
  id INT,
...
CREATE DEJAVIEW FUNCTION android_monitor_contention_graph(
