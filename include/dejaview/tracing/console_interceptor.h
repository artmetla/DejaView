...
#ifndef INCLUDE_DEJAVIEW_TRACING_CONSOLE_INTERCEPTOR_H_
#define INCLUDE_DEJAVIEW_TRACING_CONSOLE_INTERCEPTOR_H_
...
#define DEJAVIEW_PRINTF_ATTR \
  __attribute__((format(printf, /*format_index=*/2, /*first_to_check=*/3)))
#else
#define DEJAVIEW_PRINTF_ATTR
#endif

#if DEJAVIEW_BUILDFLAG(DEJAVIEW_OS_WIN) && !defined(STDOUT_FILENO)
...
class DEJAVIEW_EXPORT_COMPONENT ConsoleInterceptor
 ...
 private:
  ...
  static void PrintDebugAnnotationName(
      InterceptorContext&,
      const dejaview::protos::pbzero::DebugAnnotation_Decoder& annotation);
...
#endif  // INCLUDE_DEJAVIEW_TRACING_CONSOLE_INTERCEPTOR_H_
