...
#ifndef INCLUDE_DEJAVIEW_EXT_TRACING_CORE_SHARED_MEMORY_H_
#define INCLUDE_DEJAVIEW_EXT_TRACING_CORE_SHARED_MEMORY_H_
...
class DEJAVIEW_EXPORT_COMPONENT SharedMemory {
 public:
  class DEJAVIEW_EXPORT_COMPONENT Factory {
   public:
    virtual ~Factory();
...
#endif  // INCLUDE_DEJAVIEW_EXT_TRACING_CORE_SHARED_MEMORY_H_
