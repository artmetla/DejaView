...
INCLUDE DEJAVIEW MODULE prelude.casts;

-- Alias of the `counter` table.
CREATE DEJAVIEW VIEW counters(
  -- Alias of `counter.id`.
  id INT,
...
CREATE DEJAVIEW VIEW perf_session(
