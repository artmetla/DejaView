...
#ifndef INCLUDE_DEJAVIEW_EXT_BASE_HASH_H_
#define INCLUDE_DEJAVIEW_EXT_BASE_HASH_H_
...
// identity function and DejaView uses open-addressing hash table, which are
...
#endif  // INCLUDE_DEJAVIEW_EXT_BASE_HASH_H_
