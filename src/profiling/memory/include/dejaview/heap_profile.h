...
#ifndef SRC_PROFILING_MEMORY_INCLUDE_DEJAVIEW_HEAP_PROFILE_H_
#define SRC_PROFILING_MEMORY_INCLUDE_DEJAVIEW_HEAP_PROFILE_H_
...
#endif  // SRC_PROFILING_MEMORY_INCLUDE_DEJAVIEW_HEAP_PROFILE_H_
