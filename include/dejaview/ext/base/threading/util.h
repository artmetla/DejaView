...
#ifndef INCLUDE_DEJAVIEW_EXT_BASE_THREADING_UTIL_H_
#define INCLUDE_DEJAVIEW_EXT_BASE_THREADING_UTIL_H_
   ...
   private:
    void RunFn() {
      pool_->PostTask([channel = channel_, fn = fn_]() mutable {
        ...
        DEJAVIEW_CHECK(write_res.success);
        DEJAVIEW_CHECK(!write_res.is_closed);
      });
    }
...
#endif  // INCLUDE_DEJAVIEW_EXT_BASE_THREADING_UTIL_H_
