...
#ifndef INCLUDE_DEJAVIEW_EXT_BASE_STRING_UTILS_H_
#define INCLUDE_DEJAVIEW_EXT_BASE_STRING_UTILS_H_
...
class StackString {
 public:
  explicit DEJAVIEW_PRINTF_FORMAT(/* 1=this */ 2, 3)
...
#endif  // INCLUDE_DEJAVIEW_EXT_BASE_STRING_UTILS_H_
