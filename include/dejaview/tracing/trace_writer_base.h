...
#ifndef INCLUDE_DEJAVIEW_TRACING_TRACE_WRITER_BASE_H_
#define INCLUDE_DEJAVIEW_TRACING_TRACE_WRITER_BASE_H_
...
#endif  // INCLUDE_DEJAVIEW_TRACING_TRACE_WRITER_BASE_H_
