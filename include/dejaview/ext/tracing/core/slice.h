...
#ifndef INCLUDE_DEJAVIEW_EXT_TRACING_CORE_SLICE_H_
#define INCLUDE_DEJAVIEW_EXT_TRACING_CORE_SLICE_H_
...
#endif  // INCLUDE_DEJAVIEW_EXT_TRACING_CORE_SLICE_H_
