...
CREATE DEJAVIEW VIEW mem_all_processes AS
...
CREATE DEJAVIEW VIEW mem_all_process_priorities AS
...
CREATE DEJAVIEW VIEW process_priority_view AS
SELECT
  process_name,
...
CREATE DEJAVIEW VIEW process_metrics_view AS
SELECT
...
CREATE DEJAVIEW VIEW android_mem_output AS
SELECT
  AndroidMemoryMetric(
    'process_metrics',
