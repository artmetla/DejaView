...
CREATE DEJAVIEW VIEW all_chrome_processes AS
...
CREATE DEJAVIEW VIEW all_chrome_threads AS
...
CREATE DEJAVIEW VIEW chrome_subprocess_types AS
...
CREATE DEJAVIEW VIEW chrome_process AS
SELECT PROCESS.*,
...
CREATE DEJAVIEW VIEW chrome_thread AS
SELECT thread.*,
  CASE
