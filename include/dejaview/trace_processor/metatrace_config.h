...
#ifndef INCLUDE_DEJAVIEW_TRACE_PROCESSOR_METATRACE_CONFIG_H_
#define INCLUDE_DEJAVIEW_TRACE_PROCESSOR_METATRACE_CONFIG_H_
...
#endif  // INCLUDE_DEJAVIEW_TRACE_PROCESSOR_METATRACE_CONFIG_H_
