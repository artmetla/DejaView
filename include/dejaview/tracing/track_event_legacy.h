...
#ifndef INCLUDE_DEJAVIEW_TRACING_TRACK_EVENT_LEGACY_H_
#define INCLUDE_DEJAVIEW_TRACING_TRACK_EVENT_LEGACY_H_
...
// events in new code, the DEJAVIEW_ENABLE_LEGACY_TRACE_EVENTS macro must be set
...
#ifndef DEJAVIEW_ENABLE_LEGACY_TRACE_EVENTS
#define DEJAVIEW_ENABLE_LEGACY_TRACE_EVENTS 0
#endif
...
template <>
ThreadTrack DEJAVIEW_EXPORT_COMPONENT
ConvertThreadId(const DejaViewLegacyCurrentThreadId&);
...
// below.
#define DEJAVIEW_INTERNAL_LEGACY_EVENT_ON_TRACK(phase, category, name, track, \
                                                ...)                          \
  DEJAVIEW_INTERNAL_TRACK_EVENT_WITH_METHOD(                                  \
      TraceForCategory, category,                                             \
      ::dejaview::internal::DecayEventNameType(name),                         \
      ::dejaview::internal::TrackEventLegacy::PhaseToType(phase), track,      \
      ##__VA_ARGS__);

#define DEJAVIEW_INTERNAL_LEGACY_EVENT_WITH_FLAGS_ON_TRACK(              \
...
#define DEJAVIEW_INTERNAL_LEGACY_EVENT_WITH_ID_ON_TRACK(                 \
...
// |thread_id|.
#define DEJAVIEW_INTERNAL_LEGACY_EVENT(phase, category, name, flags,       \
                                       thread_id, ...)                     \
  [&]() {                                                                  \
    using ::dejaview::internal::TrackEventInternal;                        \
    DEJAVIEW_DCHECK(!(flags & TRACE_EVENT_FLAG_COPY));                     \
    ...
    if ((phase) == TRACE_EVENT_PHASE_INSTANT) {                            \
      ...
      switch (scope) {                                                     \
        case TRACE_EVENT_SCOPE_GLOBAL:                                     \
          DEJAVIEW_INTERNAL_LEGACY_EVENT_WITH_FLAGS_ON_TRACK(              \
              phase, category, name, ::dejaview::Track::Global(0), flags,  \
              ##__VA_ARGS__);                                              \
          return;                                                          \
        case TRACE_EVENT_SCOPE_PROCESS:                                    \
          DEJAVIEW_INTERNAL_LEGACY_EVENT_WITH_FLAGS_ON_TRACK(              \
              phase, category, name, ::dejaview::ProcessTrack::Current(),  \
              flags, ##__VA_ARGS__);                                       \
          return;                                                          \
        default:                                                           \
    ...
    if (std::is_same<                                                      \
            decltype(thread_id),                                           \
            ::dejaview::legacy::DejaViewLegacyCurrentThreadId>::value ||   \
      ...
      DEJAVIEW_INTERNAL_LEGACY_EVENT_WITH_FLAGS_ON_TRACK(                  \
          phase, category, name,                                           \
          ::dejaview::legacy::ConvertThreadId(thread_id), flags,           \
          ##__VA_ARGS__);                                                  \
    }                                                                      \
  }()

#define DEJAVIEW_INTERNAL_LEGACY_EVENT_WITH_ID(phase, category, name, flags, \
                                               thread_id, id, ...)           \
  [&]() {                                                                    \
    using ::dejaview::internal::TrackEventInternal;                          \
    DEJAVIEW_DCHECK(!(flags & TRACE_EVENT_FLAG_COPY));                       \
    ...
    if ((phase) == TRACE_EVENT_PHASE_INSTANT) {                              \
      ...
      switch (scope) {                                                       \
        case TRACE_EVENT_SCOPE_GLOBAL:                                       \
          DEJAVIEW_INTERNAL_LEGACY_EVENT_WITH_ID_ON_TRACK(                   \
              phase, category, name, ::dejaview::Track::Global(0), flags,    \
    ...
    if (std::is_same<                                                        \
      ...
      DEJAVIEW_INTERNAL_LEGACY_EVENT_WITH_ID_ON_TRACK(                       \
          phase, category, name,                                             \
          ::dejaview::legacy::ConvertThreadId(thread_id), flags, thread_id,  \
          id, ##__VA_ARGS__);                                                \
    }                                                                        \
  }()

#define INTERNAL_TRACE_EVENT_ADD(phase, category, name, flags, ...)           \
  DEJAVIEW_INTERNAL_LEGACY_EVENT(                                             \
      phase, category, ::dejaview::internal::DecayEventNameType(name), flags, \
      ::dejaview::legacy::kCurrentThreadId, ##__VA_ARGS__)

#define INTERNAL_TRACE_EVENT_ADD_SCOPED(category, name, ...) \
  DEJAVIEW_INTERNAL_SCOPED_TRACK_EVENT(                      \
      category, ::dejaview::internal::DecayEventNameType(name), ##__VA_ARGS__)

#define INTERNAL_TRACE_EVENT_ADD_SCOPED_WITH_FLOW(category, name, bind_id, \
                                                  flags, ...)              \
  DEJAVIEW_INTERNAL_SCOPED_LEGACY_TRACK_EVENT_WITH_ID(                     \
      category, ::dejaview::internal::DecayEventNameType(name),            \
      ::dejaview::internal::TrackEventInternal::kDefaultTrack, flags,      \
...
#define INTERNAL_TRACE_EVENT_ADD_WITH_TIMESTAMP(phase, category, name,        \
  ...
  DEJAVIEW_INTERNAL_LEGACY_EVENT(                                             \
      phase, category, ::dejaview::internal::DecayEventNameType(name), flags, \
      ::dejaview::legacy::kCurrentThreadId, timestamp, ##__VA_ARGS__)

#define INTERNAL_TRACE_EVENT_ADD_WITH_ID_TID_AND_TIMESTAMP(                   \
    phase, category, name, id, thread_id, timestamp, flags, ...)              \
  DEJAVIEW_INTERNAL_LEGACY_EVENT_WITH_ID(                                     \
      phase, category, ::dejaview::internal::DecayEventNameType(name), flags, \
...
#define INTERNAL_TRACE_EVENT_ADD_WITH_ID(phase, category, name, id, flags,    \
  ...
  DEJAVIEW_INTERNAL_LEGACY_EVENT_WITH_ID(                                     \
      phase, category, ::dejaview::internal::DecayEventNameType(name), flags, \
      ::dejaview::legacy::kCurrentThreadId, id, ##__VA_ARGS__)
...
#define TRACE_EVENT1(category_group, name, arg1_name, arg1_val) \
  INTERNAL_TRACE_EVENT_ADD_SCOPED(                              \
      ...
      ::dejaview::internal::PossiblyNull(arg1_val))
...
#define TRACE_EVENT2(category_group, name, arg1_name, arg1_val, arg2_name, \
  ...
  INTERNAL_TRACE_EVENT_ADD_SCOPED(                                         \
      category_group, name, arg1_name,                                     \
      ::dejaview::internal::PossiblyNull(arg1_val), arg2_name,             \
      ::dejaview::internal::PossiblyNull(arg2_val))
...
#define TRACE_EVENT_COPY_INSTANT0(category_group, name, scope)        \
  INTERNAL_TRACE_EVENT_ADD(TRACE_EVENT_PHASE_INSTANT, category_group, \
                           ::dejaview::DynamicString{name}, scope)
#define TRACE_EVENT_COPY_INSTANT1(category_group, name, scope, arg1_name, \
                                  arg1_val)                               \
  INTERNAL_TRACE_EVENT_ADD(TRACE_EVENT_PHASE_INSTANT, category_group,     \
                           ::dejaview::DynamicString{name}, scope,        \
                           ::dejaview::DynamicString{arg1_name},          \
                           ::dejaview::internal::PossiblyNull(arg1_val))
#define TRACE_EVENT_COPY_INSTANT2(category_group, name, scope, arg1_name, \
  ...
  INTERNAL_TRACE_EVENT_ADD(TRACE_EVENT_PHASE_INSTANT, category_group,     \
                           ...
                           ::dejaview::DynamicString{arg1_name},          \
                           ::dejaview::internal::PossiblyNull(arg1_val),  \
                           ::dejaview::DynamicString{arg2_name},          \
                           ::dejaview::internal::PossiblyNull(arg2_val))
...
#define TRACE_EVENT_INSTANT_WITH_TIMESTAMP1(category_group, name, scope,  \
  ...
  INTERNAL_TRACE_EVENT_ADD_WITH_TIMESTAMP(                                \
      ...
      ::dejaview::internal::PossiblyNull(arg_val))
...
#define TRACE_EVENT_BEGIN2(category_group, name, arg1_name, arg1_val,       \
  ...
  INTERNAL_TRACE_EVENT_ADD(                                                 \
      ...
      arg1_name, ::dejaview::internal::PossiblyNull(arg1_val), arg2_name,   \
      ::dejaview::internal::PossiblyNull(arg2_val))
...
#define TRACE_EVENT_COPY_BEGIN_WITH_ID_TID_AND_TIMESTAMP0(       \
  ...
  INTERNAL_TRACE_EVENT_ADD_WITH_ID_TID_AND_TIMESTAMP(            \
      ...
      ::dejaview::DynamicString{name}, id, thread_id, timestamp, \
      TRACE_EVENT_FLAG_NONE)
#define TRACE_EVENT_COPY_BEGIN_WITH_ID_TID_AND_TIMESTAMP1(               \
  ...
  INTERNAL_TRACE_EVENT_ADD_WITH_ID_TID_AND_TIMESTAMP(                    \
      TRACE_EVENT_PHASE_ASYNC_BEGIN, category_group,                     \
      ::dejaview::DynamicString{name}, id, thread_id, timestamp,         \
      TRACE_EVENT_FLAG_NONE, ::dejaview::DynamicString{arg1_name},       \
      ::dejaview::internal::PossiblyNull(arg1_val))
...
#define TRACE_EVENT_COPY_END2(category_group, name, arg1_name, arg1_val,      \
                              arg2_name, arg2_val)                            \
  INTERNAL_TRACE_EVENT_ADD(                                                   \
      TRACE_EVENT_PHASE_END, category_group, ::dejaview::DynamicString{name}, \
      TRACE_EVENT_FLAG_NONE, ::dejaview::DynamicString{arg1_name},            \
      ::dejaview::internal::PossiblyNull(arg1_val),                           \
      ::dejaview::DynamicString{arg2_name},                                   \
      ::dejaview::internal::PossiblyNull(arg2_val))
...
#define TRACE_EVENT_COPY_MARK1(category_group, name, arg1_name, arg1_val)      \
  INTERNAL_TRACE_EVENT_ADD(                                                    \
      TRACE_EVENT_PHASE_MARK, category_group, ::dejaview::DynamicString{name}, \
      TRACE_EVENT_FLAG_NONE, ::dejaview::DynamicString{arg1_name},             \
      ::dejaview::internal::PossiblyNull(arg1_val))
...
#define TRACE_COPY_COUNTER2(category_group, name, value1_name, value1_val, \
  ...
  INTERNAL_TRACE_EVENT_ADD(                                                \
      ...
      ::dejaview::DynamicString{name}, TRACE_EVENT_FLAG_NONE, value1_name, \
...
#define TRACE_COPY_COUNTER_ID1(category_group, name, id, value)               \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(TRACE_EVENT_PHASE_COUNTER, category_group, \
                                   ::dejaview::DynamicString{name}, id,       \
                                   TRACE_EVENT_FLAG_NONE, "value",            \
                                   static_cast<int>(value))
...
#define TRACE_COPY_COUNTER_ID2(category_group, name, id, value1_name,          \
  ...
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(                                            \
      TRACE_EVENT_PHASE_COUNTER, category_group,                               \
      ::dejaview::DynamicString{name}, id, TRACE_EVENT_FLAG_NONE, value1_name, \
      static_cast<int>(value1_val), value2_name, static_cast<int>(value2_val))
...
#define TRACE_EVENT_COPY_ASYNC_BEGIN0(category_group, name, id) \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(                             \
      TRACE_EVENT_PHASE_ASYNC_BEGIN, category_group,            \
      ::dejaview::DynamicString{name}, id, TRACE_EVENT_FLAG_NONE)
...
#define TRACE_EVENT_ASYNC_BEGIN_WITH_TIMESTAMP1(                           \
  ...
  INTERNAL_TRACE_EVENT_ADD_WITH_ID_TID_AND_TIMESTAMP(                      \
      TRACE_EVENT_PHASE_ASYNC_BEGIN, category_group, name, id,             \
      TRACE_EVENT_API_CURRENT_THREAD_ID, timestamp, TRACE_EVENT_FLAG_NONE, \
      arg1_name, ::dejaview::internal::PossiblyNull(arg1_val))
...
#define TRACE_EVENT_COPY_ASYNC_BEGIN_WITH_TIMESTAMP0(category_group, name, id, \
  ...
  INTERNAL_TRACE_EVENT_ADD_WITH_ID_TID_AND_TIMESTAMP(                          \
      TRACE_EVENT_PHASE_ASYNC_BEGIN, category_group,                           \
      ::dejaview::DynamicString{name}, id, TRACE_EVENT_API_CURRENT_THREAD_ID,  \
      timestamp, TRACE_EVENT_FLAG_NONE)
...
#define TRACE_EVENT_COPY_NESTABLE_ASYNC_BEGIN_WITH_TTS2(                \
  ...
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(                                     \
      ...
      ::dejaview::DynamicString{name}, id, TRACE_EVENT_FLAG_ASYNC_TTS,  \
      ::dejaview::DynamicString{arg1_name},                             \
      ::dejaview::internal::PossiblyNull(arg1_val),                     \
      ::dejaview::DynamicString{arg2_name},                             \
      ::dejaview::internal::PossiblyNull(arg2_val))
...
#define TRACE_EVENT_COPY_NESTABLE_ASYNC_BEGIN_WITH_TIMESTAMP1(                \
  ...
  INTERNAL_TRACE_EVENT_ADD_WITH_ID_TID_AND_TIMESTAMP(                         \
      TRACE_EVENT_PHASE_NESTABLE_ASYNC_BEGIN, category_group,                 \
      ::dejaview::DynamicString{name}, id, TRACE_EVENT_API_CURRENT_THREAD_ID, \
      timestamp, TRACE_EVENT_FLAG_NONE, ::dejaview::DynamicString{arg1_name}, \
      ::dejaview::internal::PossiblyNull(arg1_val))
...
#define TRACE_EVENT_IS_NEW_TRACE(ret)                                \
  do {                                                               \
    static int DEJAVIEW_UID(prev) = -1;                              \
    int DEJAVIEW_UID(curr) =                                         \
        ::dejaview::internal::TrackEventInternal::GetSessionCount(); \
    if (DEJAVIEW_TRACK_EVENT_NAMESPACE::TrackEvent::IsEnabled() &&   \
        (DEJAVIEW_UID(prev) != DEJAVIEW_UID(curr))) {                \
      *(ret) = true;                                                 \
      DEJAVIEW_UID(prev) = DEJAVIEW_UID(curr);                       \
    } else {                                                         \
      *(ret) = false;                                                \
...
#define TRACE_STR_COPY(str) \
  ::dejaview::DynamicString { ::dejaview::internal::PossiblyNull(str) }

#define TRACE_ID_WITH_SCOPE(scope, ...) \
  ::dejaview::internal::LegacyTraceId::WithScope(scope, ##__VA_ARGS__)
...
#define TRACE_ID_GLOBAL(id) ::dejaview::internal::LegacyTraceId::GlobalId(id)
...
#define TRACE_ID_LOCAL(id) ::dejaview::internal::LegacyTraceId::LocalId(id)
...
#define TRACE_EVENT_API_GET_CATEGORY_GROUP_ENABLED(category)              \
  reinterpret_cast<const uint8_t*>(                                       \
      [&] {                                                               \
        static_assert(                                                    \
            !std::is_same<::dejaview::DynamicCategory,                    \
                          decltype(category)>::value,                     \
            "Enabled flag pointers are not supported for dynamic trace "  \
            "categories.");                                               \
      },                                                                  \
      DEJAVIEW_TRACK_EVENT_NAMESPACE::internal::kCategoryRegistry         \
          .GetCategoryState(                                              \
              DEJAVIEW_TRACK_EVENT_NAMESPACE::internal::kCategoryRegistry \
...
#endif  // INCLUDE_DEJAVIEW_TRACING_TRACK_EVENT_LEGACY_H_
