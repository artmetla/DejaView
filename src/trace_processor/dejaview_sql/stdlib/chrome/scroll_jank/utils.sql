...
INCLUDE DEJAVIEW MODULE chrome.event_latency;
...
CREATE DEJAVIEW FUNCTION _is_janky_frame(cur_gesture_id LONG,
...
-- percentage.
CREATE DEJAVIEW FUNCTION _jank_budget(
  cur_frame_exact FLOAT,
...
CREATE DEJAVIEW FUNCTION chrome_select_long_task_slices(
  -- The name of slice.
  name STRING)
RETURNS TABLE(
