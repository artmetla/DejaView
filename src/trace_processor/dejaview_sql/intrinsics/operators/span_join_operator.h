...
#ifndef SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_INTRINSICS_OPERATORS_SPAN_JOIN_OPERATOR_H_
#define SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_INTRINSICS_OPERATORS_SPAN_JOIN_OPERATOR_H_
 ...
 public:
  ...
  class TableDefinition {
   public:
    ...
    static base::Status Create(DejaViewSqlEngine* engine,
  ...
  class Query {
   public:
    ...
    int64_t partition() const {
      DEJAVIEW_DCHECK(!IsEof() && defn_->IsPartitioned());
      return partition_;
    }
  ...
  struct Context {
    explicit Context(DejaViewSqlEngine* _engine) : engine(_engine) {}
...
#endif  // SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_INTRINSICS_OPERATORS_SPAN_JOIN_OPERATOR_H_
