...
static const char kHeader[] =
    "// DO NOT EDIT. Autogenerated by DejaView cppgen_plugin\n";
...
bool CppObjGenerator::Generate(const google::protobuf::FileDescriptor* file,
  ...
  h_printer.Print("#include \"dejaview/protozero/cpp_message_obj.h\"\n");
  h_printer.Print("#include \"dejaview/protozero/copyable_ptr.h\"\n");
  h_printer.Print("#include \"dejaview/base/export.h\"\n\n");

  cc_printer.Print("#include \"dejaview/protozero/gen_field_helpers.h\"\n");
  cc_printer.Print("#include \"dejaview/protozero/message.h\"\n");
  cc_printer.Print(
      "#include \"dejaview/protozero/packed_repeated_fields.h\"\n");
  cc_printer.Print("#include \"dejaview/protozero/proto_decoder.h\"\n");
  cc_printer.Print("#include \"dejaview/protozero/scattered_heap_buffer.h\"\n");
...
void CppObjGenerator::GenClassDecl(const Descriptor* msg, Printer* p) const {
  ...
  p->Print(
      "\nclass DEJAVIEW_EXPORT_COMPONENT $n$ : public "
  ...
  for (int i = 0; i < msg->field_count(); i++) {
    ...
    name[0] = dejaview::base::Uppercase(name[0]);
...
void CppObjGenerator::GenClassDef(const Descriptor* msg, Printer* p) const {
  ...
  for (int i = 0; i < msg->field_count(); i++) {
    ...
    if (field->options().lazy()) {
      ...
      if (field->is_packed()) {
        DEJAVIEW_CHECK(field->is_repeated());
        if (field->type() == TYPE_SINT32 || field->type() == TYPE_SINT64) {
          DEJAVIEW_FATAL("packed signed (zigzag) fields are not supported");
        }
        p->Print(
            "if "
