...
#ifndef INCLUDE_DEJAVIEW_EXT_BASE_UNIX_TASK_RUNNER_H_
#define INCLUDE_DEJAVIEW_EXT_BASE_UNIX_TASK_RUNNER_H_
...
#endif  // INCLUDE_DEJAVIEW_EXT_BASE_UNIX_TASK_RUNNER_H_
