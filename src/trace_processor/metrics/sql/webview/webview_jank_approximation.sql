...
CREATE DEJAVIEW VIEW webview_processes AS
SELECT * FROM process
...
CREATE DEJAVIEW VIEW system_processes AS
SELECT * FROM process
...
CREATE DEJAVIEW TABLE webview_browser_startup_slices AS
...
CREATE DEJAVIEW TABLE webview_renderer_slices AS
...
CREATE DEJAVIEW TABLE all_self_jank_slices AS
SELECT *
...
CREATE DEJAVIEW VIEW webview_app_jank_slices AS
...
CREATE DEJAVIEW VIEW webview_all_app_jank_slices AS
SELECT * FROM all_self_jank_slices
...
CREATE DEJAVIEW VIEW webview_janks_slices_without_startup AS
...
CREATE DEJAVIEW VIEW webview_jank_approximation_summary AS
...
CREATE DEJAVIEW VIEW webview_jank_approximation_output AS
