...
#ifndef SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_ENGINE_RUNTIME_TABLE_FUNCTION_H_
#define SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_ENGINE_RUNTIME_TABLE_FUNCTION_H_
...
struct RuntimeTableFunctionModule
  ...
  struct State {
    ...
    bool IsReturnValueColumn(size_t i) const {
      DEJAVIEW_DCHECK(i < TotalColumnCount());
...
#endif  // SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_ENGINE_RUNTIME_TABLE_FUNCTION_H_
