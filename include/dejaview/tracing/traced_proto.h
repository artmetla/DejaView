...
#ifndef INCLUDE_DEJAVIEW_TRACING_TRACED_PROTO_H_
#define INCLUDE_DEJAVIEW_TRACING_TRACED_PROTO_H_
...
// class Foo {
//  public:
//   void WriteIntoTrace(dejaview::TracedProto<pbzero::Foo> message) {
 ...
 public:
  ...
  TracedDictionary AddDebugAnnotations() && {
    static_assert(
        ...
        "'repeated dejaview.protos.DebugAnnotation debug_annnotations = N;' "
...
// If dejaview::TraceFormatTraits<T>::WriteIntoTrace(TracedProto<MessageType>,
...
// dejaview::WriteIntoTracedProto. These templates will fail to resolve if the
...
#endif  // INCLUDE_DEJAVIEW_TRACING_TRACED_PROTO_H_
