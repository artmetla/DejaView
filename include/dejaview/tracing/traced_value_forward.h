...
#ifndef INCLUDE_DEJAVIEW_TRACING_TRACED_VALUE_FORWARD_H_
#define INCLUDE_DEJAVIEW_TRACING_TRACED_VALUE_FORWARD_H_
...
//   WriteIntoTrace(dejaview::TracedValue context) const {
//      WriteIntoTracedValue(std::move(context), *ptr_);
//   }
//
//   template <typename MessageType>
//   typename check_traced_value_support<T, MessageType>::value
//   WriteIntoTrace(dejaview::TracedProto<MessageType> message) const {
...
#endif  // INCLUDE_DEJAVIEW_TRACING_TRACED_VALUE_FORWARD_H_
