...
```bash
docker run europe-docker.pkg.dev/dejaview-ui/builder/dejaview-ui-builder \
...
# You need to be a member of dejaview-cloud-infra.prod to do this.
gcloud auth print-access-token \
    --impersonate-service-account dejaview-ui-dev@dejaview-ui.iam.gserviceaccount.com | docker login \
    -u oauth2accesstoken \
    --password-stdin https://europe-docker.pkg.dev

docker build -t europe-docker.pkg.dev/dejaview-ui/builder/dejaview-ui-builder infra/ui.perfetto.dev/builder
docker push europe-docker.pkg.dev/dejaview-ui/builder/dejaview-ui-builder
```
