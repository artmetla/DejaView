...
from dejaview.batch_trace_processor.platform import PlatformDelegate
from dejaview.common.exceptions import DejaViewException
from dejaview.trace_processor.api import PLATFORM_DELEGATE as TP_PLATFORM_DELEGATE
...
class BatchTraceProcessor:
  """Run ad-hoc SQL queries across many DejaView traces.
