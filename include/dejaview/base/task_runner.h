...
#ifndef INCLUDE_DEJAVIEW_BASE_TASK_RUNNER_H_
#define INCLUDE_DEJAVIEW_BASE_TASK_RUNNER_H_
...
class DEJAVIEW_EXPORT_COMPONENT TaskRunner {
 public:
  virtual ~TaskRunner();
  ...
  // dejaview) to inform the caller that anything posted will run on the same
...
#endif  // INCLUDE_DEJAVIEW_BASE_TASK_RUNNER_H_
