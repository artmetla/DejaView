...
#ifndef INCLUDE_DEJAVIEW_TRACING_DEBUG_ANNOTATION_H_
#define INCLUDE_DEJAVIEW_TRACING_DEBUG_ANNOTATION_H_
...
class DEJAVIEW_EXPORT_COMPONENT DebugAnnotation {
 public:
...
#endif  // INCLUDE_DEJAVIEW_TRACING_DEBUG_ANNOTATION_H_
