...
CREATE DEJAVIEW VIEW _chrome_speedometer_2_1_mark_name(
  -- Expected slice name
  name STRING,
  -- Suite name
  suite_name STRING,
...
CREATE DEJAVIEW TABLE chrome_speedometer_2_1_measure(
...
CREATE DEJAVIEW TABLE chrome_speedometer_2_1_iteration(
...
CREATE DEJAVIEW FUNCTION chrome_speedometer_2_1_score()
...
CREATE DEJAVIEW FUNCTION chrome_speedometer_2_1_renderer_main_utid()
-- Renderer main utid
RETURNS INT
AS
SELECT utid
