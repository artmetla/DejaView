...
#ifndef INCLUDE_DEJAVIEW_BASE_THREAD_UTILS_H_
#define INCLUDE_DEJAVIEW_BASE_THREAD_UTILS_H_
...
DEJAVIEW_EXPORT_COMPONENT PlatformThreadId GetThreadId();
...
#endif  // INCLUDE_DEJAVIEW_BASE_THREAD_UTILS_H_
