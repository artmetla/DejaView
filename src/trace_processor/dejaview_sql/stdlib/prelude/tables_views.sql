...
INCLUDE DEJAVIEW MODULE prelude.views;
...
CREATE DEJAVIEW VIEW track (
  ...
  -- created using DejaView's track_event API.
  parent_id UINT,
...
-- running at.
CREATE DEJAVIEW VIEW cpu_available_frequencies (
...
CREATE DEJAVIEW VIEW sched_slice (
...
CREATE DEJAVIEW VIEW thread_state (
...
CREATE DEJAVIEW VIEW cpu_track (
...
CREATE DEJAVIEW VIEW cpu_counter_track (
