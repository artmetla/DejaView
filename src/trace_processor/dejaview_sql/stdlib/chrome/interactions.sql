...
INCLUDE DEJAVIEW MODULE chrome.scroll_interactions;
INCLUDE DEJAVIEW MODULE chrome.startups;
INCLUDE DEJAVIEW MODULE chrome.web_content_interactions;

-- All critical user interaction events, including type and table with
-- associated metrics.
CREATE DEJAVIEW TABLE chrome_interactions(
