...
#ifndef INCLUDE_DEJAVIEW_EXT_TRACING_CORE_PRODUCER_H_
#define INCLUDE_DEJAVIEW_EXT_TRACING_CORE_PRODUCER_H_
...
class DEJAVIEW_EXPORT_COMPONENT Producer {
 public:
  virtual ~Producer();
...
#endif  // INCLUDE_DEJAVIEW_EXT_TRACING_CORE_PRODUCER_H_
