...
CREATE DEJAVIEW TABLE _heap_graph_dominator_tree_bottom_up_scan AS
SELECT *
...
CREATE DEJAVIEW TABLE _heap_graph_dominator_tree_top_down_scan AS
SELECT *
FROM _graph_scan!(
  (
...
CREATE DEJAVIEW TABLE heap_graph_dominator_tree(
