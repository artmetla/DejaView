...
from dejaview.bigtrace.protos.dejaview.bigtrace import orchestrator_pb2 as protos_dot_dejaview_dot_bigtrace_dot_orchestrator__pb2
...
class BigtraceOrchestratorStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Query = channel.unary_stream(
        '/dejaview.protos.BigtraceOrchestrator/Query',
        request_serializer=protos_dot_dejaview_dot_bigtrace_dot_orchestrator__pb2
        .BigtraceQueryArgs.SerializeToString,
        response_deserializer=protos_dot_dejaview_dot_bigtrace_dot_orchestrator__pb2
  ...
  rpc_method_handlers = {
      'Query':
          grpc.unary_stream_rpc_method_handler(
              servicer.Query,
              request_deserializer=protos_dot_dejaview_dot_bigtrace_dot_orchestrator__pb2
              .BigtraceQueryArgs.FromString,
              response_serializer=protos_dot_dejaview_dot_bigtrace_dot_orchestrator__pb2
              .BigtraceQueryResponse.SerializeToString,
          ),
  }
  generic_handler = grpc.method_handlers_generic_handler(
      'dejaview.protos.BigtraceOrchestrator', rpc_method_handlers)
...
class BigtraceOrchestrator(object):
  ...
  def Query(request,
    ...
    return grpc.experimental.unary_stream(
        request, target, '/dejaview.protos.BigtraceOrchestrator/Query',
        protos_dot_dejaview_dot_bigtrace_dot_orchestrator__pb2.BigtraceQueryArgs
        .SerializeToString,
        protos_dot_dejaview_dot_bigtrace_dot_orchestrator__pb2
