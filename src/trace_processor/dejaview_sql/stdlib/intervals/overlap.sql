...
CREATE DEJAVIEW MACRO intervals_overlap_count(
...
-- macro.
CREATE DEJAVIEW MACRO _intervals_overlap_in_table(
...
CREATE DEJAVIEW MACRO _intervals_merge_root_and_children(
...
CREATE DEJAVIEW MACRO _intervals_flatten(children_with_roots_table TableOrSubquery)
