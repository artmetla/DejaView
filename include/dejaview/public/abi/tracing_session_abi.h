...
#ifndef INCLUDE_DEJAVIEW_PUBLIC_ABI_TRACING_SESSION_ABI_H_
#define INCLUDE_DEJAVIEW_PUBLIC_ABI_TRACING_SESSION_ABI_H_
...
struct DejaViewTracingSessionImpl;

DEJAVIEW_SDK_EXPORT struct DejaViewTracingSessionImpl*
DejaViewTracingSessionSystemCreate(void);

DEJAVIEW_SDK_EXPORT struct DejaViewTracingSessionImpl*
DejaViewTracingSessionInProcessCreate(void);

DEJAVIEW_SDK_EXPORT void DejaViewTracingSessionSetup(
    struct DejaViewTracingSessionImpl*,
    void* cfg_begin,
    size_t cfg_len);

typedef void (*DejaViewTracingSessionStopCb)(struct DejaViewTracingSessionImpl*,
                                             void* user_arg);

// Calls `*cb` with `user_arg` when the tracing session is stopped.
DEJAVIEW_SDK_EXPORT void DejaViewTracingSessionSetStopCb(
    struct DejaViewTracingSessionImpl*,
    DejaViewTracingSessionStopCb cb,
    void* user_arg);

DEJAVIEW_SDK_EXPORT void DejaViewTracingSessionStartAsync(
    struct DejaViewTracingSessionImpl*);

DEJAVIEW_SDK_EXPORT void DejaViewTracingSessionStartBlocking(
    struct DejaViewTracingSessionImpl*);

DEJAVIEW_SDK_EXPORT void DejaViewTracingSessionStopAsync(
    struct DejaViewTracingSessionImpl*);

DEJAVIEW_SDK_EXPORT void DejaViewTracingSessionStopBlocking(
    struct DejaViewTracingSessionImpl*);
...
typedef void (*DejaViewTracingSessionFlushCb)(
    struct DejaViewTracingSessionImpl*,
    bool success,
    void* user_arg);
...
// DejaViewTracingSessionReadTraceBlocking() function. Returns immediately and
// invokes a callback when the flush request is complete.
// Args:
//  `cb`: will be invoked on an internal dejaview thread when all data
...
//    of 5s will be used.
DEJAVIEW_SDK_EXPORT void DejaViewTracingSessionFlushAsync(
    struct DejaViewTracingSessionImpl*,
    uint32_t timeout_ms,
    DejaViewTracingSessionFlushCb cb,
    void* user_arg);

// Like DejaViewTracingSessionFlushAsync(), but blocks until the flush is
// complete (i.e. every data source has acknowledged or the timeout has
// expired).
DEJAVIEW_SDK_EXPORT bool DejaViewTracingSessionFlushBlocking(
    struct DejaViewTracingSessionImpl*,
    uint32_t timeout_ms);
...
typedef void (*DejaViewTracingSessionReadCb)(struct DejaViewTracingSessionImpl*,
                                             const void* data,
                                             size_t size,
                                             bool has_more,
                                             void* user_arg);
...
DEJAVIEW_SDK_EXPORT void DejaViewTracingSessionReadTraceBlocking(
    struct DejaViewTracingSessionImpl*,
    DejaViewTracingSessionReadCb cb,
    void* user_arg);

DEJAVIEW_SDK_EXPORT void DejaViewTracingSessionDestroy(
    struct DejaViewTracingSessionImpl*);
...
#endif  // INCLUDE_DEJAVIEW_PUBLIC_ABI_TRACING_SESSION_ABI_H_
