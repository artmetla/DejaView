...
CREATE DEJAVIEW VIEW _android_io_f2fs_counter_stats(
...
CREATE DEJAVIEW VIEW _android_io_f2fs_write_stats(
  -- Utid of the thread.
  utid INT,
  -- Tid of the thread.
  tid INT,
...
-- and bytes written
CREATE DEJAVIEW VIEW _android_io_f2fs_aggregate_write_stats(
