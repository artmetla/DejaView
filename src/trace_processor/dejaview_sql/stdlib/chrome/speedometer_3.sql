...
CREATE DEJAVIEW VIEW _chrome_speedometer_3_measure_name(
  -- Expected slice name
  name STRING,
  -- Suite name
  suite_name STRING,
...
CREATE DEJAVIEW VIEW _chrome_speedometer_3_iteration_slice
AS
WITH
  data AS (
...
CREATE DEJAVIEW TABLE chrome_speedometer_3_measure(
...
CREATE DEJAVIEW TABLE chrome_speedometer_3_iteration(
...
CREATE DEJAVIEW FUNCTION chrome_speedometer_3_score()
-- Speedometer 3 score
RETURNS DOUBLE
AS
...
CREATE DEJAVIEW FUNCTION chrome_speedometer_3_renderer_main_utid()
-- Renderer main utid
RETURNS INT
AS
WITH
