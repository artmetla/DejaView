...
#ifndef INCLUDE_DEJAVIEW_EXT_TRACING_CORE_TRACE_PACKET_H_
#define INCLUDE_DEJAVIEW_EXT_TRACING_CORE_TRACE_PACKET_H_
...
class DEJAVIEW_EXPORT_COMPONENT TracePacket {
 public:
...
#endif  // INCLUDE_DEJAVIEW_EXT_TRACING_CORE_TRACE_PACKET_H_
