...
#ifndef INCLUDE_DEJAVIEW_EXT_BASE_THREADING_STREAM_H_
#define INCLUDE_DEJAVIEW_EXT_BASE_THREADING_STREAM_H_
...
#endif  // INCLUDE_DEJAVIEW_EXT_BASE_THREADING_STREAM_H_
