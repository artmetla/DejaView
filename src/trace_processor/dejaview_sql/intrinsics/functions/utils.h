...
#ifndef SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_INTRINSICS_FUNCTIONS_UTILS_H_
#define SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_INTRINSICS_FUNCTIONS_UTILS_H_
...
struct Regex : public SqlFunction {
  static base::Status Run(void*,
    ...
    DEJAVIEW_FATAL("Regex not supported");
  }
};
...
#endif  // SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_INTRINSICS_FUNCTIONS_UTILS_H_
