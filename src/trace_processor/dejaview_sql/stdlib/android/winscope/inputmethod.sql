...
CREATE DEJAVIEW VIEW android_inputmethod_clients(
  -- Dump id
  id INT,
...
CREATE DEJAVIEW VIEW android_inputmethod_manager_service(
  -- Dump id
  id INT,
  -- Timestamp when the dump was triggered
  ts INT,
...
CREATE DEJAVIEW VIEW android_inputmethod_service(
  -- Dump id
  id INT,
  -- Timestamp when the dump was triggered
  ts INT,
