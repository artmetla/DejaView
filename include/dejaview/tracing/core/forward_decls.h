...
#ifndef INCLUDE_DEJAVIEW_TRACING_CORE_FORWARD_DECLS_H_
#define INCLUDE_DEJAVIEW_TRACING_CORE_FORWARD_DECLS_H_
...
// .proto(s) at CL *check-in* time (!= build time) in the ::dejaview namespace.
// Nowadays we have code everywhere that assume the right class is
// ::dejaview::TraceConfig or the like. Back then other headers could just
// forward declared ::dejaview::TraceConfig. These days, the real class is
// ::dejaview::protos::gen::TraceConfig and core/trace_config.h aliases that as
// using ::dejaview::TraceConfig = ::dejaview::protos::gen::TraceConfig.
...
// The .cc file includes dejaview/tracing/core/trace_config.h (or equiv). That
// header will pull the full declaration from trace_config.gen.h and will also
// setup the alias in the ::dejaview namespace.
...
using ChromeConfig = ::dejaview::protos::gen::ChromeConfig;
using CommitDataRequest = ::dejaview::protos::gen::CommitDataRequest;
using DataSourceConfig = ::dejaview::protos::gen::DataSourceConfig;
using DataSourceDescriptor = ::dejaview::protos::gen::DataSourceDescriptor;
using ObservableEvents = ::dejaview::protos::gen::ObservableEvents;
using TraceConfig = ::dejaview::protos::gen::TraceConfig;
using TraceStats = ::dejaview::protos::gen::TraceStats;
using TracingServiceCapabilities =
    ::dejaview::protos::gen::TracingServiceCapabilities;
using TracingServiceState = ::dejaview::protos::gen::TracingServiceState;
using SyncClockRequest = ::dejaview::protos::gen::SyncClockRequest;
using SyncClockResponse = ::dejaview::protos::gen::SyncClockResponse;

}  // namespace dejaview

#endif  // INCLUDE_DEJAVIEW_TRACING_CORE_FORWARD_DECLS_H_
