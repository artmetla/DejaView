...
#ifndef INCLUDE_DEJAVIEW_EXT_PROTOZERO_PROTO_RING_BUFFER_H_
#define INCLUDE_DEJAVIEW_EXT_PROTOZERO_PROTO_RING_BUFFER_H_
...
class RingBufferMessageReader {
 ...
 private:
  dejaview::base::PagedMemory buf_;
  Message fastpath_{};
...
#endif  // INCLUDE_DEJAVIEW_EXT_PROTOZERO_PROTO_RING_BUFFER_H_
