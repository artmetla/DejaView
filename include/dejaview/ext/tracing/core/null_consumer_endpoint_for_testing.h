...
#ifndef INCLUDE_DEJAVIEW_EXT_TRACING_CORE_NULL_CONSUMER_ENDPOINT_FOR_TESTING_H_
#define INCLUDE_DEJAVIEW_EXT_TRACING_CORE_NULL_CONSUMER_ENDPOINT_FOR_TESTING_H_
...
// code in other repos like arctraceservice/DejaViewClient_test.cpp which
// ended up depending on internal dejaview interfaces against our plans.
...
class NullConsumerEndpointForTesting : public ConsumerEndpoint {
 public:
  ...
  void ChangeTraceConfig(const dejaview::TraceConfig&) override {}
...
#endif  // INCLUDE_DEJAVIEW_EXT_TRACING_CORE_NULL_CONSUMER_ENDPOINT_FOR_TESTING_H_
