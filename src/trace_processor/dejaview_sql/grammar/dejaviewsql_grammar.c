...
** source file "src/trace_processor/dejaview_sql/grammar/dejaviewsql_grammar.y".
*/
/*
** 2000-05-29
**
...
**                       token.
**    DejaViewSqlParserTOKENTYPE     is the data type used for minor type for terminal
...
**                       which is DejaViewSqlParserTOKENTYPE.  The entry in the union
**                       for terminal symbols is called "yy0".
**    YYSTACKDEPTH       is the maximum depth of the parser's stack.  If
**                       zero the stack is dynamically sized using realloc()
**    DejaViewSqlParserARG_SDECL     A static variable declaration for the %extra_argument
**    DejaViewSqlParserARG_PDECL     A parameter declaration for the %extra_argument
**    DejaViewSqlParserARG_PARAM     Code to pass %extra_argument as a subroutine parameter
**    DejaViewSqlParserARG_STORE     Code to store %extra_argument into yypParser
**    DejaViewSqlParserARG_FETCH     Code to extract %extra_argument from yypParser
**    DejaViewSqlParserCTX_*         As DejaViewSqlParserARG_ except for %extra_context
...
#define DejaViewSqlParserTOKENTYPE void*
typedef union {
  int yyinit;
  DejaViewSqlParserTOKENTYPE yy0;
} YYMINORTYPE;
#ifndef YYSTACKDEPTH
#define YYSTACKDEPTH 100
#endif
#define DejaViewSqlParserARG_SDECL
#define DejaViewSqlParserARG_PDECL
#define DejaViewSqlParserARG_PARAM
#define DejaViewSqlParserARG_FETCH
#define DejaViewSqlParserARG_STORE
#define DejaViewSqlParserCTX_SDECL
#define DejaViewSqlParserCTX_PDECL
#define DejaViewSqlParserCTX_PARAM
#define DejaViewSqlParserCTX_FETCH
#define DejaViewSqlParserCTX_STORE
#define YYFALLBACK 1
#define YYNSTATE             579
#define YYNRULE              405
...
#endif
  DejaViewSqlParserARG_SDECL                /* A place to hold %extra_argument */
  DejaViewSqlParserCTX_SDECL                /* A place to hold %extra_context */
#if YYSTACKDEPTH<=0
...
** None.
*/
void DejaViewSqlParserTrace(FILE *TraceFILE, char *zTracePrompt){
...
** second argument to DejaViewSqlParserAlloc() below.  This can be changed by
...
*/
void DejaViewSqlParserInit(void *yypRawParser DejaViewSqlParserCTX_PDECL){
  yyParser *yypParser = (yyParser*)yypRawParser;
  DejaViewSqlParserCTX_STORE
#ifdef YYTRACKMAXSTACKDEPTH
  yypParser->yyhwm = 0;
#endif
#if YYSTACKDEPTH<=0
...
#ifndef DejaViewSqlParser_ENGINEALWAYSONSTACK
/* 
...
** to DejaViewSqlParser and DejaViewSqlParserFree.
*/
void *DejaViewSqlParserAlloc(void *(*mallocProc)(YYMALLOCARGTYPE) DejaViewSqlParserCTX_PDECL){
  yyParser *yypParser;
  yypParser = (yyParser*)(*mallocProc)( (YYMALLOCARGTYPE)sizeof(yyParser) );
  if( yypParser ){
    DejaViewSqlParserCTX_STORE
    DejaViewSqlParserInit(yypParser DejaViewSqlParserCTX_PARAM);
  }
  return (void*)yypParser;
}
#endif /* DejaViewSqlParser_ENGINEALWAYSONSTACK */
...
static void yy_destructor(
  ...
  DejaViewSqlParserARG_FETCH
  DejaViewSqlParserCTX_FETCH
  switch( yymajor ){
...
*/
void DejaViewSqlParserFinalize(void *p){
...
*/
#ifdef YYTRACKMAXSTACKDEPTH
int DejaViewSqlParserStackPeak(void *p){
  yyParser *pParser = (yyParser*)p;
...
*/
#if defined(YYCOVERAGE)
int DejaViewSqlParserCoverage(FILE *out){
...
/******** End %stack_overflow code ********************************************/
   DejaViewSqlParserARG_STORE /* Suppress warning about unused %extra_argument var */
   DejaViewSqlParserCTX_STORE
}
...
static void yy_shift(
  ...
  DejaViewSqlParserTOKENTYPE yyMinor        /* The minor token to shift in */
){
  yyStackEntry *yytos;
  yypParser->yytos++;
#ifdef YYTRACKMAXSTACKDEPTH
...
static YYACTIONTYPE yy_reduce(
  ...
  DejaViewSqlParserTOKENTYPE yyLookaheadToken  /* Value of the lookahead token */
  DejaViewSqlParserCTX_PDECL                   /* %extra_context */
){
...
/************ End %parse_failure code *****************************************/
  DejaViewSqlParserARG_STORE /* Suppress warning about unused %extra_argument variable */
  DejaViewSqlParserCTX_STORE
}
...
static void yy_syntax_error(
  ...
  DejaViewSqlParserTOKENTYPE yyminor         /* The minor type of the error token */
){
  DejaViewSqlParserARG_FETCH
  DejaViewSqlParserCTX_FETCH
...
** "DejaViewSqlParserAlloc" which describes the current state of the parser.
...
** None.
*/
void DejaViewSqlParser(
  void *yyp,                   /* The parser */
  int yymajor,                 /* The major token code number */
  DejaViewSqlParserTOKENTYPE yyminor       /* The value for the token */
  DejaViewSqlParserARG_PDECL               /* Optional %extra_argument parameter */
){
  ...
  while(1){ /* Exit by "break" */
    ...
    if( yyact >= YY_MIN_REDUCE ){
      ...
      ** enough on the stack to push the LHS value */
      ...
      yyact = yy_reduce(yypParser,yyruleno,yymajor,yyminor DejaViewSqlParserCTX_PARAM);
...
*/
int DejaViewSqlParserFallback(int iToken){
#ifdef YYFALLBACK
