...
INCLUDE DEJAVIEW MODULE wattson.cpu_freq;
INCLUDE DEJAVIEW MODULE wattson.cpu_idle;
INCLUDE DEJAVIEW MODULE wattson.curves.utils;
INCLUDE DEJAVIEW MODULE wattson.device_infos;

-- Helper macro for using DejaView table with interval intersect
CREATE DEJAVIEW MACRO _ii_subquery(tab TableOrSubquery)
...
CREATE DEJAVIEW TABLE _valid_window
AS
...
CREATE DEJAVIEW TABLE _idle_freq_materialized
AS
SELECT
