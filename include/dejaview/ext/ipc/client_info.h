...
#ifndef INCLUDE_DEJAVIEW_EXT_IPC_CLIENT_INFO_H_
#define INCLUDE_DEJAVIEW_EXT_IPC_CLIENT_INFO_H_
...
class ClientInfo {
 public:
  ...
  bool operator<(const ClientInfo& other) const {
    DEJAVIEW_DCHECK(client_id_ != other.client_id_ || *this == other);
 ...
 private:
  ...
  // sync with dejaview::ClientIdentity.
...
#endif  // INCLUDE_DEJAVIEW_EXT_IPC_CLIENT_INFO_H_
