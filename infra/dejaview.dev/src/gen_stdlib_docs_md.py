...
INTRODUCTION = '''
# DejaViewSQL standard library
*This page documents the DejaViewSQL standard library.*

## Introduction
The DejaViewSQL standard library is a repository of tables, views, functions
...
[syntax documentation](/docs/analysis/dejaview-sql-syntax#including-dejaviewsql-modules)
for the `INCLUDE DEJAVIEW MODULE` statement.
