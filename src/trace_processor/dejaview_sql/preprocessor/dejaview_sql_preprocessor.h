...
#ifndef SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_PREPROCESSOR_DEJAVIEW_SQL_PREPROCESSOR_H_
#define SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_PREPROCESSOR_DEJAVIEW_SQL_PREPROCESSOR_H_
...
// Preprocessor for DejaViewSQL statements. The main responsiblity of this
...
class DejaViewSqlPreprocessor {
 public:
  ...
  explicit DejaViewSqlPreprocessor(
      SqlSource,
...
#endif  // SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_PREPROCESSOR_DEJAVIEW_SQL_PREPROCESSOR_H_
