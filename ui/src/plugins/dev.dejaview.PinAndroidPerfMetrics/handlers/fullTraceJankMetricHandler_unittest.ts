...
const validMetricsTest: {
  ...
  {
    inputMetric: 'dejaview_ft_launcher-missed_app_frames-mean',
    expectedOutput: {
  ...
  {
    inputMetric: 'dejaview_ft_systemui-missed_sf_frames-mean',
    expectedOutput: {
  ...
  {
    inputMetric: 'dejaview_ft_systemui-missed_app_frames-mean',
    expectedOutput: {
      process: 'com.android.systemui',
      jankType: 'app_frames',
    },
