...
#ifndef INCLUDE_DEJAVIEW_TEST_TRACED_VALUE_TEST_SUPPORT_H_
#define INCLUDE_DEJAVIEW_TEST_TRACED_VALUE_TEST_SUPPORT_H_
...
namespace internal {
DEJAVIEW_EXPORT_COMPONENT std::string DebugAnnotationToString(
...
#endif  // INCLUDE_DEJAVIEW_TEST_TRACED_VALUE_TEST_SUPPORT_H_
