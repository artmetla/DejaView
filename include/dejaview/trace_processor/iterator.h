...
#ifndef INCLUDE_DEJAVIEW_TRACE_PROCESSOR_ITERATOR_H_
#define INCLUDE_DEJAVIEW_TRACE_PROCESSOR_ITERATOR_H_
...
//   printf("\n");
// }
class DEJAVIEW_EXPORT_COMPONENT Iterator {
 public:
...
#endif  // INCLUDE_DEJAVIEW_TRACE_PROCESSOR_ITERATOR_H_
