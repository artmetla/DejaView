...
#ifndef INCLUDE_DEJAVIEW_EXT_BASE_THREADING_POLL_H_
#define INCLUDE_DEJAVIEW_EXT_BASE_THREADING_POLL_H_
...
#endif  // INCLUDE_DEJAVIEW_EXT_BASE_THREADING_POLL_H_
