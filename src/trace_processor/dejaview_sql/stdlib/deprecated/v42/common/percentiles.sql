...
INCLUDE DEJAVIEW MODULE deprecated.v42.common.counters;
INCLUDE DEJAVIEW MODULE deprecated.v42.common.timestamps;

CREATE DEJAVIEW FUNCTION _number_generator(upper_limit INT)
...
CREATE DEJAVIEW FUNCTION _earliest_timestamp_for_counter_track(
...
CREATE DEJAVIEW FUNCTION _counter_for_time_range(
...
CREATE DEJAVIEW FUNCTION counter_percentiles_for_time_range(
...
CREATE DEJAVIEW FUNCTION counter_percentiles_for_track(
  -- Id of the counter track.
  counter_track_id INT)
RETURNS TABLE(
  -- All of the numbers from 1 to 100.
...
CREATE DEJAVIEW FUNCTION counter_track_percentile_for_time(
  -- Id of the counter track.
  counter_track_id INT,
...
CREATE DEJAVIEW FUNCTION counter_track_percentile(
  -- Id of the counter track.
  counter_track_id INT,
  -- Any of the numbers from 1 to 100.
  percentile INT)
