...
CREATE DEJAVIEW VIEW android_jank_cuj_slice AS
SELECT
  cuj_id,
  process.upid,
...
CREATE DEJAVIEW TABLE android_jank_cuj_main_thread_slice AS
SELECT
  cuj_id,
  upid,
  utid,
...
CREATE DEJAVIEW TABLE android_jank_cuj_render_thread_slice AS
SELECT
  cuj_id,
  upid,
  utid,
...
CREATE DEJAVIEW VIEW android_jank_cuj_sf_slice AS
SELECT
  cuj_id,
  upid,
...
CREATE DEJAVIEW TABLE android_jank_cuj_sf_main_thread_slice AS
SELECT
  cuj_id,
  upid,
  utid,
...
CREATE DEJAVIEW TABLE android_jank_cuj_sf_render_engine_slice AS
SELECT
  cuj_id,
  upid,
  utid,
