...
class AndroidClientServer implements DejaViewPlugin {
  async onTraceLoad(ctx: Trace): Promise<void> {
    ctx.commands.registerCommand({
      id: 'dev.dejaview.AndroidClientServer#ThreadRuntimeIPC',
      ...
      callback: async (sliceId) => {
        ...
        await ctx.engine.query(`
          ...
          create or replace dejaview table __binder_for_slice_${sliceId} as
        ...
        await ctx.engine.query(`
          ...
          create or replace dejaview table __enhanced_binder_for_slice_${sliceId} as
          with foo as (
            select
              bfs.id as binder_id,
...
export const plugin: PluginDescriptor = {
  pluginId: 'dev.dejaview.AndroidClientServer',
