...
CREATE DEJAVIEW VIEW chrome_input_to_browser_longer_intervals AS
SELECT
  *
...
CREATE DEJAVIEW VIEW chrome_task_barrages_per_interval AS
SELECT
...
CREATE DEJAVIEW VIEW chrome_scroll_jank_caused_by_scheduling AS
SELECT *
