...
GERRIT_PROJECT = 'platform/external/dejaview'
...
GCS_ARTIFACTS = 'dejaview-ci-artifacts'
...
# Only variables starting with DEJAVIEW_ are propagated into the sandbox.
JOB_CONFIGS = {
    'linux-clang-x86_64-debug': {
        'DEJAVIEW_TEST_GN_ARGS': 'is_debug=true is_hermetic_clang=false '
                                 'non_hermetic_clang_stdlib="libc++" '
                                 'enable_dejaview_merged_protos_check=true',
        'DEJAVIEW_TEST_SCRIPT': 'test/ci/linux_tests.sh',
        'DEJAVIEW_INSTALL_BUILD_DEPS_ARGS': '',
    },
    'linux-clang-x86_64-tsan': {
        'DEJAVIEW_TEST_GN_ARGS': 'is_debug=false is_tsan=true',
        'DEJAVIEW_TEST_SCRIPT': 'test/ci/linux_tests.sh',
        'DEJAVIEW_INSTALL_BUILD_DEPS_ARGS': '',
    },
    'linux-clang-x86_64-msan': {
        'DEJAVIEW_TEST_GN_ARGS': 'is_debug=false is_msan=true',
        'DEJAVIEW_TEST_SCRIPT': 'test/ci/linux_tests.sh',
        'DEJAVIEW_INSTALL_BUILD_DEPS_ARGS': '',
    },
    'linux-clang-x86_64-asan_lsan': {
        'DEJAVIEW_TEST_GN_ARGS': 'is_debug=false is_asan=true is_lsan=true',
        'DEJAVIEW_TEST_SCRIPT': 'test/ci/linux_tests.sh',
        'DEJAVIEW_INSTALL_BUILD_DEPS_ARGS': '',
    },
    'linux-clang-x86-release': {
        'DEJAVIEW_TEST_GN_ARGS': 'is_debug=false target_cpu="x86"',
        'DEJAVIEW_TEST_SCRIPT': 'test/ci/linux_tests.sh',
        'DEJAVIEW_INSTALL_BUILD_DEPS_ARGS': '',
    },
    'linux-gcc8-x86_64-release': {
        'DEJAVIEW_TEST_GN_ARGS':
            'is_debug=false is_clang=false enable_dejaview_grpc=true '
            'cc="gcc-8" cxx="g++-8"',
        'DEJAVIEW_TEST_SCRIPT': 'test/ci/linux_tests.sh',
        'DEJAVIEW_INSTALL_BUILD_DEPS_ARGS': '--grpc',
    },
    ...
    'linux-clang-x86_64-libfuzzer': {
        'DEJAVIEW_TEST_GN_ARGS': 'is_debug=false is_fuzzer=true is_asan=true',
        'DEJAVIEW_TEST_SCRIPT': 'test/ci/fuzzer_tests.sh',
        'DEJAVIEW_INSTALL_BUILD_DEPS_ARGS': '',
    },
    'linux-clang-x86_64-bazel': {
        'DEJAVIEW_TEST_GN_ARGS': '',
        'DEJAVIEW_TEST_SCRIPT': 'test/ci/bazel_tests.sh',
        'DEJAVIEW_INSTALL_BUILD_DEPS_ARGS': '',
    },
    'ui-clang-x86_64-release': {
        'DEJAVIEW_TEST_GN_ARGS': 'is_debug=false',
        'DEJAVIEW_TEST_SCRIPT': 'test/ci/ui_tests.sh',
        'DEJAVIEW_INSTALL_BUILD_DEPS_ARGS': '--ui',
    },
}
