...
#ifndef INCLUDE_DEJAVIEW_EXT_BASE_STRING_WRITER_H_
#define INCLUDE_DEJAVIEW_EXT_BASE_STRING_WRITER_H_
...
class StringWriter {
 public:
  ...
  void AppendHexInt(IntType value) {
    ...
    DEJAVIEW_DCHECK(pos_ + res <= size_);
    pos_ += res;
  }
 ...
 private:
  ...
  void AppendPaddedInt(uint64_t absolute_value, bool negate) {
    ...
    DEJAVIEW_DCHECK(pos_ + kSizeNeeded <= size_);
...
#endif  // INCLUDE_DEJAVIEW_EXT_BASE_STRING_WRITER_H_
