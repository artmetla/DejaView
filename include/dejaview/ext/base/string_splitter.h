...
#ifndef INCLUDE_DEJAVIEW_EXT_BASE_STRING_SPLITTER_H_
#define INCLUDE_DEJAVIEW_EXT_BASE_STRING_SPLITTER_H_
...
#endif  // INCLUDE_DEJAVIEW_EXT_BASE_STRING_SPLITTER_H_
