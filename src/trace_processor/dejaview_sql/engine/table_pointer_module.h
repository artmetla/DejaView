...
#ifndef SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_ENGINE_TABLE_POINTER_MODULE_H_
#define SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_ENGINE_TABLE_POINTER_MODULE_H_
...
#endif  // SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_ENGINE_TABLE_POINTER_MODULE_H_
