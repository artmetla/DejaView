...
#ifndef INCLUDE_DEJAVIEW_EXT_BASE_THREADING_FUTURE_COMBINATORS_H_
#define INCLUDE_DEJAVIEW_EXT_BASE_THREADING_FUTURE_COMBINATORS_H_
...
class ContinueWithImpl : public FuturePollable<B> {
 public:
  ...
  FuturePollResult<B> Poll(PollContext* context) override {
    DEJAVIEW_CHECK((first_ && second_fn_) || second_);
    if (first_) {
...
#endif  // INCLUDE_DEJAVIEW_EXT_BASE_THREADING_FUTURE_COMBINATORS_H_
