 ...
 * This way when comparing two different dejaview traces before and after
 * the regression, the user will not have to manually search for the
 * slices related to the regressed metric
 */
class PinAndroidPerfMetrics implements DejaViewPlugin {
  ...
  async onTraceReady(ctx: Trace) {
    ctx.commands.registerCommand({
      id: 'dev.dejaview.PinAndroidPerfMetrics#PinAndroidPerfMetrics',
