...
#ifndef INCLUDE_DEJAVIEW_TRACING_CORE_TRACE_CONFIG_H_
#define INCLUDE_DEJAVIEW_TRACING_CORE_TRACE_CONFIG_H_
...
#endif  // INCLUDE_DEJAVIEW_TRACING_CORE_TRACE_CONFIG_H_
