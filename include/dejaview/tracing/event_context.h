...
#ifndef INCLUDE_DEJAVIEW_TRACING_EVENT_CONTEXT_H_
#define INCLUDE_DEJAVIEW_TRACING_EVENT_CONTEXT_H_
...
//                     });
//
class DEJAVIEW_EXPORT_COMPONENT EventContext {
 public:
  ...
  // using dejaview::TracedValue API. Users should generally prefer passing
...
#endif  // INCLUDE_DEJAVIEW_TRACING_EVENT_CONTEXT_H_
