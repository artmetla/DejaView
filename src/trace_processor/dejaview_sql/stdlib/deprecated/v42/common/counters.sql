...
CREATE DEJAVIEW FUNCTION earliest_timestamp_for_counter_track(
...
CREATE DEJAVIEW FUNCTION counter_with_dur_for_track(
...
CREATE DEJAVIEW FUNCTION counter_for_time_range(
  -- Id of track counter track.
  counter_track_id INT,
