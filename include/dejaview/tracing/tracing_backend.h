...
#ifndef INCLUDE_DEJAVIEW_TRACING_TRACING_BACKEND_H_
#define INCLUDE_DEJAVIEW_TRACING_TRACING_BACKEND_H_
...
// Extending this class requires depending on the full set of dejaview headers
...
class DEJAVIEW_EXPORT_COMPONENT TracingProducerBackend {
 public:
  ...
  struct ConnectProducerArgs {
    ...
    ::dejaview::base::TaskRunner* task_runner = nullptr;
...
class DEJAVIEW_EXPORT_COMPONENT TracingConsumerBackend {
 public:
  ...
  struct ConnectConsumerArgs {
    ...
    ::dejaview::base::TaskRunner* task_runner{};
  };
  virtual std::unique_ptr<ConsumerEndpoint> ConnectConsumer(
      const ConnectConsumerArgs&) = 0;
};

class DEJAVIEW_EXPORT_COMPONENT TracingBackend : public TracingProducerBackend,
...
#endif  // INCLUDE_DEJAVIEW_TRACING_TRACING_BACKEND_H_
