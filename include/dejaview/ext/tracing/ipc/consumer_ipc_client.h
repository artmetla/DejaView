...
#ifndef INCLUDE_DEJAVIEW_EXT_TRACING_IPC_CONSUMER_IPC_CLIENT_H_
#define INCLUDE_DEJAVIEW_EXT_TRACING_IPC_CONSUMER_IPC_CLIENT_H_
...
class DEJAVIEW_EXPORT_COMPONENT ConsumerIPCClient {
 public:
...
#endif  // INCLUDE_DEJAVIEW_EXT_TRACING_IPC_CONSUMER_IPC_CLIENT_H_
