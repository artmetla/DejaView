...
-- On Linux/Android dejaview profilers (heapprofd, traced_perf) record the
...
CREATE DEJAVIEW VIEW mangled_stack_profile_mapping AS
SELECT
  id,
  name,
  build_id,
...
CREATE DEJAVIEW VIEW unsymbolized_frames_view AS
...
CREATE DEJAVIEW VIEW unsymbolized_frames_output AS
