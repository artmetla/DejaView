...
-- All process starts.
CREATE DEJAVIEW VIEW _proc_start
AS
...
CREATE DEJAVIEW TABLE _cold_start
AS
WITH
  lifecycle_slice AS (
    SELECT
...
CREATE DEJAVIEW VIEW _cold_proc_start
AS
SELECT
  cold_start.*,
...
CREATE DEJAVIEW TABLE _provider_start
AS
WITH
  provider_start AS (
...
CREATE DEJAVIEW VIEW _provider_proc_start
AS
SELECT
  cold_start.*,
  MAX(proc_start.ts) AS proc_start_ts,
...
CREATE DEJAVIEW TABLE android_app_process_starts(
