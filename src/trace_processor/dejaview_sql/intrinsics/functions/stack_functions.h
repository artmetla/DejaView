...
#ifndef SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_INTRINSICS_FUNCTIONS_STACK_FUNCTIONS_H_
#define SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_INTRINSICS_FUNCTIONS_STACK_FUNCTIONS_H_
...
//
// See protos/dejaview/trace_processor/stack.proto
base::Status RegisterStackFunctions(DejaViewSqlEngine* engine,
                                    TraceProcessorContext* context);

}  // namespace trace_processor
}  // namespace dejaview

#endif  // SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_INTRINSICS_FUNCTIONS_STACK_FUNCTIONS_H_
