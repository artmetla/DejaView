...
#ifndef INCLUDE_DEJAVIEW_EXT_BASE_GETOPT_COMPAT_H_
#define INCLUDE_DEJAVIEW_EXT_BASE_GETOPT_COMPAT_H_
...
// DejaView codebase. It doesn't even try to deal with the full surface of GNU's
// getopt().
// Limitations:
...
#endif  // INCLUDE_DEJAVIEW_EXT_BASE_GETOPT_COMPAT_H_
