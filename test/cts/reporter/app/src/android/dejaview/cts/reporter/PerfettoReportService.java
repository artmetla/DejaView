...
package android.dejaview.cts.reporter;
...
public class DejaViewReportService extends TraceReportService {
    public static final String TAG = "DejaViewReportService";
