...
CREATE DEJAVIEW TABLE touch_move_and_begin_flow AS
SELECT
  flow.begin_flow_id,
  flow.begin_flow_ts,
...
CREATE DEJAVIEW TABLE touch_move_begin_and_end_flow AS
SELECT
  flow.end_flow_id,
  flow.end_flow_ts,
...
CREATE DEJAVIEW TABLE touch_move_with_ancestor AS
SELECT
...
CREATE DEJAVIEW TABLE blocking_touch_move_with_scroll_update AS
SELECT
...
CREATE DEJAVIEW VIEW scroll_jank_cause_blocking_touch_move AS
SELECT
  id,
  ts,
  dur,
