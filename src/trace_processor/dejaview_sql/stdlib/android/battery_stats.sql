...
CREATE DEJAVIEW FUNCTION android_battery_stats_counter_to_string(
...
-- given time.
CREATE DEJAVIEW VIEW android_battery_stats_state(
...
--     int_value=10215
CREATE DEJAVIEW VIEW android_battery_stats_event_slices(
  -- Timestamp in nanoseconds.
  ts INT,
  -- The duration the state was active, may be negative for incomplete slices.
  dur INT,
