...
const validMetricsTest: {
  ...
  {
    inputMetric:
      'dejaview_cuj_systemui-NOTIFICATION_SHADE_EXPAND_COLLAPSE::Expand-timeline_metrics-missed_app_frames-mean',
    expectedOutput: {
  ...
  {
    inputMetric:
      'dejaview_cuj_systemui-SHADE_DIALOG_OPEN::internet-timeline_metrics-missed_sf_frames-mean',
    expectedOutput: {
      process: 'com.android.systemui',
