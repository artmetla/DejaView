...
#ifndef SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_INTRINSICS_FUNCTIONS_LAYOUT_FUNCTIONS_H_
#define SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_INTRINSICS_FUNCTIONS_LAYOUT_FUNCTIONS_H_
...
base::Status RegisterLayoutFunctions(DejaViewSqlEngine& engine);

}  // namespace dejaview::trace_processor

#endif  // SRC_TRACE_PROCESSOR_DEJAVIEW_SQL_INTRINSICS_FUNCTIONS_LAYOUT_FUNCTIONS_H_
