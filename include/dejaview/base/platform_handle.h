...
#ifndef INCLUDE_DEJAVIEW_BASE_PLATFORM_HANDLE_H_
#define INCLUDE_DEJAVIEW_BASE_PLATFORM_HANDLE_H_
...
// to them (which in DejaView is a PlatformHandle), and that can be used in
...
// system headers like Windows.h through dejaview headers.
...
#endif  // INCLUDE_DEJAVIEW_BASE_PLATFORM_HANDLE_H_
