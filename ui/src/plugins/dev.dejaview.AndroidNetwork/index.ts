...
class AndroidNetwork implements DejaViewPlugin {
  ...
  async onTraceLoad(ctx: Trace): Promise<void> {
    ctx.commands.registerCommand({
      id: 'dev.dejaview.AndroidNetwork#batteryEvents',
    ...
    ctx.commands.registerCommand({
      id: 'dev.dejaview.AndroidNetwork#activityTrack',
...
export const plugin: PluginDescriptor = {
  pluginId: 'dev.dejaview.AndroidNetwork',
