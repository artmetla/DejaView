...
CREATE DEJAVIEW FUNCTION _export_firefox_thread_markers()
RETURNS STRING
AS
SELECT json_object(
      'data', json_array(),
...
-- https://github.com/firefox-devtools/profiler/blob/main/src/types/profile.js
CREATE DEJAVIEW FUNCTION _export_firefox_native_symbol_table()
RETURNS STRING
AS
SELECT
  json_object(
...
-- https://github.com/firefox-devtools/profiler/blob/main/src/types/profile.js
CREATE DEJAVIEW FUNCTION _export_firefox_resource_table()
RETURNS STRING
AS
SELECT
  json_object(
...
CREATE DEJAVIEW TABLE _export_to_firefox_table
AS
WITH
  symbol AS (
    SELECT
...
-- https://github.com/firefox-devtools/profiler/blob/main/src/types/profile.js
-- for the given `utid`.
CREATE DEJAVIEW FUNCTION _export_firefox_samples_table(utid INT)
RETURNS STRING
AS
WITH
  samples_table AS (
...
-- https://github.com/firefox-devtools/profiler/blob/main/src/types/profile.js
-- for the given `utid`.
CREATE DEJAVIEW FUNCTION _export_firefox_stack_table(utid INT)
RETURNS STRING
AS
WITH
  parent AS (
...
-- https://github.com/firefox-devtools/profiler/blob/main/src/types/profile.js
-- for the given `utid`.
CREATE DEJAVIEW FUNCTION _export_firefox_frame_table(utid INT)
RETURNS STRING
AS
WITH
  frame_table AS (
...
CREATE DEJAVIEW FUNCTION _export_firefox_string_array(utid INT)
RETURNS STRING
AS
WITH
  string_table AS (
...
-- https://github.com/firefox-devtools/profiler/blob/main/src/types/profile.js
-- for the given `utid`.
CREATE DEJAVIEW FUNCTION _export_firefox_func_table(utid INT)
RETURNS STRING
AS
WITH
  func_table AS (
...
-- https://github.com/firefox-devtools/profiler/blob/main/src/types/profile.js
-- for the given `utid`.
CREATE DEJAVIEW FUNCTION _export_firefox_thread(utid INT)
RETURNS STRING
AS
SELECT
  json_object(
...
CREATE DEJAVIEW FUNCTION _export_firefox_threads()
RETURNS STRING
AS
...
-- https://github.com/firefox-devtools/profiler/blob/main/src/types/profile.js
CREATE DEJAVIEW FUNCTION _export_firefox_meta()
RETURNS STRING
AS
SELECT
  json_object(
...
CREATE DEJAVIEW FUNCTION export_to_firefox_profile()
-- Json profile
RETURNS STRING
AS
SELECT
