...
#ifndef INCLUDE_DEJAVIEW_PROTOZERO_CPP_MESSAGE_OBJ_H_
#define INCLUDE_DEJAVIEW_PROTOZERO_CPP_MESSAGE_OBJ_H_
...
class DEJAVIEW_EXPORT_COMPONENT CppMessageObj {
 public:
...
#endif  // INCLUDE_DEJAVIEW_PROTOZERO_CPP_MESSAGE_OBJ_H_
