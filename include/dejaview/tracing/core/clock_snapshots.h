...
#ifndef INCLUDE_DEJAVIEW_TRACING_CORE_CLOCK_SNAPSHOTS_H_
#define INCLUDE_DEJAVIEW_TRACING_CORE_CLOCK_SNAPSHOTS_H_
...
#endif  // INCLUDE_DEJAVIEW_TRACING_CORE_CLOCK_SNAPSHOTS_H_
