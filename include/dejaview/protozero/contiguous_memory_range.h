...
#ifndef INCLUDE_DEJAVIEW_PROTOZERO_CONTIGUOUS_MEMORY_RANGE_H_
#define INCLUDE_DEJAVIEW_PROTOZERO_CONTIGUOUS_MEMORY_RANGE_H_
...
#endif  // INCLUDE_DEJAVIEW_PROTOZERO_CONTIGUOUS_MEMORY_RANGE_H_
