...
CREATE DEJAVIEW VIEW irq_runtime_all
AS
SELECT ts, dur, name
FROM slice
WHERE category = 'irq';
...
CREATE DEJAVIEW VIEW hw_irq_runtime
AS
SELECT ts, dur, name
...
CREATE DEJAVIEW VIEW hw_irq_runtime_statistics
AS
SELECT
...
CREATE DEJAVIEW VIEW sw_irq_runtime
AS
SELECT ts, dur, name
FROM irq_runtime_all
...
CREATE DEJAVIEW VIEW sw_irq_runtime_statistics
AS
SELECT
  MAX(dur) AS max_runtime,
...
CREATE DEJAVIEW VIEW android_irq_runtime_output
AS
SELECT
