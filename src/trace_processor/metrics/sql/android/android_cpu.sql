...
CREATE DEJAVIEW VIEW metrics_per_core_type AS
SELECT
  utid,
  core_type,
...
CREATE DEJAVIEW VIEW core_proto_per_thread AS
SELECT
  utid,
  RepeatedField(
...
CREATE DEJAVIEW VIEW core_type_proto_per_thread AS
SELECT
  utid,
  RepeatedField(
...
CREATE DEJAVIEW VIEW metrics_proto_per_thread AS
SELECT
  utid,
  AndroidCpuMetric_Metrics(
    'mcycles', SUM(mcycles),
...
CREATE DEJAVIEW VIEW thread_proto_per_process AS
SELECT
  upid,
  RepeatedField(
...
CREATE DEJAVIEW VIEW core_metrics_per_process AS
SELECT
  upid,
  cpu,
  AndroidCpuMetric_Metrics(
...
CREATE DEJAVIEW VIEW core_proto_per_process AS
SELECT
  upid,
  RepeatedField(
    AndroidCpuMetric_CoreData(
...
CREATE DEJAVIEW VIEW core_type_metrics_per_process AS
SELECT
  upid,
  core_type,
  AndroidCpuMetric_Metrics(
...
CREATE DEJAVIEW VIEW core_type_proto_per_process AS
SELECT
  upid,
  RepeatedField(
    AndroidCpuMetric_CoreTypeData(
...
CREATE DEJAVIEW VIEW metrics_proto_per_process AS
SELECT
  upid,
  AndroidCpuMetric_Metrics(
    'mcycles', SUM(mcycles),
...
CREATE DEJAVIEW VIEW android_cpu_output AS
