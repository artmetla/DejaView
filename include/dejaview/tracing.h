...
#ifndef INCLUDE_DEJAVIEW_TRACING_H_
#define INCLUDE_DEJAVIEW_TRACING_H_

// This headers wraps all the headers necessary to use the public DejaView
...
#endif  // INCLUDE_DEJAVIEW_TRACING_H_
