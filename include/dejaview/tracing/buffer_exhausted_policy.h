...
#ifndef INCLUDE_DEJAVIEW_TRACING_BUFFER_EXHAUSTED_POLICY_H_
#define INCLUDE_DEJAVIEW_TRACING_BUFFER_EXHAUSTED_POLICY_H_
...
#endif  // INCLUDE_DEJAVIEW_TRACING_BUFFER_EXHAUSTED_POLICY_H_
