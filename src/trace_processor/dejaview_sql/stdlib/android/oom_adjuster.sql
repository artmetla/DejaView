...
-- system.
CREATE DEJAVIEW FUNCTION android_oom_adj_score_to_bucket_name(
  -- `oom_score` value
  oom_score INT
)
...
CREATE DEJAVIEW FUNCTION android_oom_adj_score_to_detailed_bucket_name(
  -- oom_adj score.
  value INT,
...
CREATE DEJAVIEW TABLE _oom_adjuster_intervals AS
WITH reason AS (
  SELECT
...
CREATE DEJAVIEW VIEW android_oom_adj_intervals (
