...
#ifndef INCLUDE_DEJAVIEW_TRACE_PROCESSOR_TRACE_PROCESSOR_STORAGE_H_
#define INCLUDE_DEJAVIEW_TRACE_PROCESSOR_TRACE_PROCESSOR_STORAGE_H_
...
class DEJAVIEW_EXPORT_COMPONENT TraceProcessorStorage {
 public:
...
#endif  // INCLUDE_DEJAVIEW_TRACE_PROCESSOR_TRACE_PROCESSOR_STORAGE_H_
