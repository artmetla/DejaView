...
class CpuidleTimeInState implements DejaViewPlugin {
  ...
  async onTraceLoad(ctx: Trace): Promise<void> {
    ...
    const e = ctx.engine;
    await e.query(`INCLUDE DEJAVIEW MODULE linux.cpu.idle_time_in_state;`);
...
export const plugin: PluginDescriptor = {
  pluginId: 'dev.dejaview.CpuidleTimeInState',
