...
CREATE DEJAVIEW TABLE sched_time_in_state_for_thread(
  -- Utid of the thread.
  utid INT,
...
CREATE DEJAVIEW MACRO _case_for_state(state Expr)
RETURNS Expr AS
...
-- are rounded down.
CREATE DEJAVIEW TABLE sched_percentage_of_time_in_state(
  -- Utid of the thread.
  utid INT,
...
CREATE DEJAVIEW FUNCTION sched_time_in_state_for_thread_in_interval(
...
CREATE DEJAVIEW FUNCTION sched_time_in_state_and_cpu_for_thread_in_interval(
  -- The start of the interval.
  ts INT,
  -- The duration of the interval.
  dur INT,
...
CREATE DEJAVIEW FUNCTION sched_time_in_state_for_cpu_in_interval(
    -- CPU id.
    cpu INT,
    -- Interval start.
    ts INT,
