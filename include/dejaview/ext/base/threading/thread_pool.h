...
#ifndef INCLUDE_DEJAVIEW_EXT_BASE_THREADING_THREAD_POOL_H_
#define INCLUDE_DEJAVIEW_EXT_BASE_THREADING_THREAD_POOL_H_
...
#endif  // INCLUDE_DEJAVIEW_EXT_BASE_THREADING_THREAD_POOL_H_
