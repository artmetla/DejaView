...
// which should not depend on any DejaView compilation units other than the
// client API.

#ifndef INCLUDE_DEJAVIEW_PROFILING_PARSE_SMAPS_H_
#define INCLUDE_DEJAVIEW_PROFILING_PARSE_SMAPS_H_
...
#endif  // INCLUDE_DEJAVIEW_PROFILING_PARSE_SMAPS_H_
