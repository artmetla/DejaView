...
#ifndef INCLUDE_DEJAVIEW_EXT_TRACING_CORE_CONSUMER_H_
#define INCLUDE_DEJAVIEW_EXT_TRACING_CORE_CONSUMER_H_
...
class DEJAVIEW_EXPORT_COMPONENT Consumer {
 public:
  virtual ~Consumer();
...
#endif  // INCLUDE_DEJAVIEW_EXT_TRACING_CORE_CONSUMER_H_
