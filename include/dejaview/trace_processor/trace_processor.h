...
#ifndef INCLUDE_DEJAVIEW_TRACE_PROCESSOR_TRACE_PROCESSOR_H_
#define INCLUDE_DEJAVIEW_TRACE_PROCESSOR_TRACE_PROCESSOR_H_
...
class DEJAVIEW_EXPORT_COMPONENT TraceProcessor : public TraceProcessorStorage {
 public:
  // For legacy API clients. Iterator used to be a nested class here. Many API
  // clients depends on it at this point.
  using Iterator = ::dejaview::trace_processor::Iterator;
  ...
  // DEJAVIEW MODULE camera.cpu.metrics". The first word of the string has to be
  ...
  // dejaview/metrics/metrics.proto.
  ...
  // DescriptorSet, defined in dejaview/trace_processor/trace_processor.proto.
...
#endif  // INCLUDE_DEJAVIEW_TRACE_PROCESSOR_TRACE_PROCESSOR_H_
