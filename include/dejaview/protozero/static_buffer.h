...
#ifndef INCLUDE_DEJAVIEW_PROTOZERO_STATIC_BUFFER_H_
#define INCLUDE_DEJAVIEW_PROTOZERO_STATIC_BUFFER_H_
...
class DEJAVIEW_EXPORT_COMPONENT StaticBufferDelegate
...
#endif  // INCLUDE_DEJAVIEW_PROTOZERO_STATIC_BUFFER_H_
