...
#ifndef INCLUDE_DEJAVIEW_EXT_TRACING_CORE_CLIENT_IDENTITY_H_
#define INCLUDE_DEJAVIEW_EXT_TRACING_CORE_CLIENT_IDENTITY_H_
...
#endif  // INCLUDE_DEJAVIEW_EXT_TRACING_CORE_CLIENT_IDENTITY_H_
