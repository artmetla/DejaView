...
#ifndef INCLUDE_DEJAVIEW_EXT_TRACED_DATA_SOURCE_TYPES_H_
#define INCLUDE_DEJAVIEW_EXT_TRACED_DATA_SOURCE_TYPES_H_
...
class InodeMapValue {
 public:
  ...
  bool operator==(const dejaview::InodeMapValue& rhs) const {
...
#endif  // INCLUDE_DEJAVIEW_EXT_TRACED_DATA_SOURCE_TYPES_H_
