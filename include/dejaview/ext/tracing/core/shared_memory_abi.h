...
#ifndef INCLUDE_DEJAVIEW_EXT_TRACING_CORE_SHARED_MEMORY_ABI_H_
#define INCLUDE_DEJAVIEW_EXT_TRACING_CORE_SHARED_MEMORY_ABI_H_
...
class SharedMemoryABI {
 public:
  ...
  class Chunk {
   public:
    ...
    size_t payload_size() const {
      DEJAVIEW_DCHECK(size_ >= sizeof(ChunkHeader));
  ...
  uint8_t* page_start(size_t page_idx) {
    DEJAVIEW_DCHECK(page_idx < num_pages_);
...
#endif  // INCLUDE_DEJAVIEW_EXT_TRACING_CORE_SHARED_MEMORY_ABI_H_
