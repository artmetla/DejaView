...
#ifndef INCLUDE_DEJAVIEW_TRACING_INTERNAL_DATA_SOURCE_INTERNAL_H_
#define INCLUDE_DEJAVIEW_TRACING_INTERNAL_DATA_SOURCE_INTERNAL_H_
...
// No dejaview headers (other than tracing/api and protozero) should be here.
...
#endif  // INCLUDE_DEJAVIEW_TRACING_INTERNAL_DATA_SOURCE_INTERNAL_H_
