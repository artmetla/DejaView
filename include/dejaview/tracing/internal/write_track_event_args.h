...
#ifndef INCLUDE_DEJAVIEW_TRACING_INTERNAL_WRITE_TRACK_EVENT_ARGS_H_
#define INCLUDE_DEJAVIEW_TRACING_INTERNAL_WRITE_TRACK_EVENT_ARGS_H_
...
DEJAVIEW_ALWAYS_INLINE inline void WriteTrackEventArgs(EventContext) {}
...
DEJAVIEW_ALWAYS_INLINE void WriteTrackEventArgs(
...
DEJAVIEW_ALWAYS_INLINE void WriteTrackEventArgs(EventContext event_ctx,
                                                const char* arg_name,
                                                ArgValue&& arg_value,
                                                Args&&... args);
...
#endif  // INCLUDE_DEJAVIEW_TRACING_INTERNAL_WRITE_TRACK_EVENT_ARGS_H_
