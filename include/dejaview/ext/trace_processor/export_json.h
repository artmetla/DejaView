...
#ifndef INCLUDE_DEJAVIEW_EXT_TRACE_PROCESSOR_EXPORT_JSON_H_
#define INCLUDE_DEJAVIEW_EXT_TRACE_PROCESSOR_EXPORT_JSON_H_
...
class DEJAVIEW_EXPORT_COMPONENT OutputWriter {
 public:
  OutputWriter();
...
util::Status DEJAVIEW_EXPORT_COMPONENT
...
#endif  // INCLUDE_DEJAVIEW_EXT_TRACE_PROCESSOR_EXPORT_JSON_H_
