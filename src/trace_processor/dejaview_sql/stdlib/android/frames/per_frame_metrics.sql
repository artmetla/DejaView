...
CREATE DEJAVIEW TABLE android_frames_overrun(
    -- Frame id.
    frame_id INT,
...
CREATE DEJAVIEW TABLE android_frames_ui_time(
    -- Frame id
    frame_id INT,
    -- UI time duration
    ui_time INT
...
-- slice.
-- For Googlers: more details in go/android-performance-metrics-glossary.
CREATE DEJAVIEW TABLE android_app_vsync_delay_per_frame(
    -- Frame id
    frame_id INT,
    -- App VSYNC delay.
    app_vsync_delay INT
...
-- For Googlers: more details in go/android-performance-metrics-glossary.
CREATE DEJAVIEW TABLE android_cpu_time_per_frame(
    -- Frame id
    frame_id INT,
...
-- For Googlers: more details in go/android-performance-metrics-glossary.
CREATE DEJAVIEW TABLE _cpu_time_per_frame_fallback(
    -- Frame id.
    frame_id INT,
    -- Estimated cpu time.
...
CREATE DEJAVIEW TABLE _estimated_cpu_time_per_frame(
    frame_id INT,
    cpu_time INT
) AS
SELECT
...
--
-- For Googlers: more details in go/android-performance-metrics-glossary.
CREATE DEJAVIEW TABLE android_frame_stats(
    -- Frame id.
    frame_id INT,
