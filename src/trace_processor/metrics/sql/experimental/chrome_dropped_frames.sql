...
CREATE DEJAVIEW TABLE dropped_pipeline_reporter_slice AS
...
CREATE DEJAVIEW VIEW dropped_frames_with_upid AS
SELECT
...
CREATE DEJAVIEW VIEW dropped_frames_with_process_info AS
SELECT
...
CREATE DEJAVIEW VIEW chrome_dropped_frames_event AS
SELECT
  'slice' AS track_type,
...
CREATE DEJAVIEW VIEW chrome_dropped_frames_output AS
