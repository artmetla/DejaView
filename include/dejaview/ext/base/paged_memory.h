...
#ifndef INCLUDE_DEJAVIEW_EXT_BASE_PAGED_MEMORY_H_
#define INCLUDE_DEJAVIEW_EXT_BASE_PAGED_MEMORY_H_
...
#if DEJAVIEW_BUILDFLAG(DEJAVIEW_OS_WIN) || defined(ADDRESS_SANITIZER)
...
#endif  // INCLUDE_DEJAVIEW_EXT_BASE_PAGED_MEMORY_H_
