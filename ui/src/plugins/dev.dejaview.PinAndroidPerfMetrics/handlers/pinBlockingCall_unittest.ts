...
const validMetricsTest: {
  ...
  {
    inputMetric:
      'dejaview_android_blocking_call-cuj-name-com.google.android.apps.nexuslauncher-name-TASKBAR_EXPAND-blocking_calls-name-animation-total_dur_ms-mean',
    expectedOutput: {
  ...
  {
    inputMetric:
      'dejaview_android_blocking_call-cuj-name-com.android.systemui-name-NOTIFICATION_SHADE_EXPAND_COLLAPSE::Collapse-blocking_calls-name-AIDL::java::IPackageManager::isProtectedBroadcast::server-cnt-mean',
    expectedOutput: {
  ...
  {
    inputMetric:
      'dejaview_android_blocking_call-cuj-name-com.android.systemui-name-SPLASHSCREEN_EXIT_ANIM-blocking_calls-name-AIDL::java::IPackageManager::isProtectedBroadcast::server-cnt-mean',
    expectedOutput: {
      process: 'com.android.systemui',
...
const invalidMetricsTest: string[] = [
  'dejaview_ft_launcher-missed_sf_frames-mean',
  'dejaview_cuj_launcher-RECENTS_SCROLLING-counter_metrics-missed_sf_frames-mean',
];
