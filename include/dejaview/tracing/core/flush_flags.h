...
#ifndef INCLUDE_DEJAVIEW_TRACING_CORE_FLUSH_FLAGS_H_
#define INCLUDE_DEJAVIEW_TRACING_CORE_FLUSH_FLAGS_H_
...
#endif  // INCLUDE_DEJAVIEW_TRACING_CORE_FLUSH_FLAGS_H_
