...
#ifndef INCLUDE_DEJAVIEW_TRACING_INTERNAL_TRACING_TLS_H_
#define INCLUDE_DEJAVIEW_TRACING_INTERNAL_TRACING_TLS_H_
...
struct ScopedReentrancyAnnotator {
  ScopedReentrancyAnnotator(TracingTLS& root_tls) : root_tls_(root_tls) {
    DEJAVIEW_DCHECK(!root_tls_.is_in_trace_point);
...
#endif  // INCLUDE_DEJAVIEW_TRACING_INTERNAL_TRACING_TLS_H_
