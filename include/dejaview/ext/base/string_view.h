...
#ifndef INCLUDE_DEJAVIEW_EXT_BASE_STRING_VIEW_H_
#define INCLUDE_DEJAVIEW_EXT_BASE_STRING_VIEW_H_
...
class StringView {
 public:
  ...
  StringView(const char* data, size_t size) : data_(data), size_(size) {
    DEJAVIEW_DCHECK(size == 0 || data != nullptr);
  }
...
template <>
struct std::hash<::dejaview::base::StringView> {
  size_t operator()(const ::dejaview::base::StringView& sv) const {
    return static_cast<size_t>(sv.Hash());
  }
};

#endif  // INCLUDE_DEJAVIEW_EXT_BASE_STRING_VIEW_H_
