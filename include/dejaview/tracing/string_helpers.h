...
#ifndef INCLUDE_DEJAVIEW_TRACING_STRING_HELPERS_H_
#define INCLUDE_DEJAVIEW_TRACING_STRING_HELPERS_H_
...
class DEJAVIEW_EXPORT_COMPONENT StaticString {
 public:
...
// A explicit wrapper for marking strings as dynamic to ensure that dejaview
// doesn't try to cache the pointer value.
class DEJAVIEW_EXPORT_COMPONENT DynamicString {
 public:
...
constexpr const char* GetStaticString(dejaview::StaticString string) {
  return string.value;
}
...
#endif  // INCLUDE_DEJAVIEW_TRACING_STRING_HELPERS_H_
