...
package android.dejaview.cts.app;
...
public class JavaOomActivity extends Activity {
    ...
    public void onCreate(Bundle state) {
        ...
        new Thread(() -> {
            // Inside ART, the dejaview hprof plugin (used here to dump the heap after an OOM) will
            // use fork(). If other threads are holding some locks, the forked process might not be
            // able to make progress, in some rare cases. This is a known limitation of the dejaview
