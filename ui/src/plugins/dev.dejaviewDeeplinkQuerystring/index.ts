...
// When deep linking into DejaView UI it is possible to pass arguments in the
...
class DeeplinkQuerystring implements DejaViewPlugin {
...
export const plugin: PluginDescriptor = {
  pluginId: 'dev.dejaview.DeeplinkQuerystring',
