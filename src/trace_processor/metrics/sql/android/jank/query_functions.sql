...
-- Example usage:
--
-- CREATE DEJAVIEW VIEW example_table AS
...
CREATE OR REPLACE DEJAVIEW FUNCTION android_jank_correlate_frame_slice_impl(
  table_set STRING,
...
CREATE OR REPLACE DEJAVIEW FUNCTION android_jank_correlate_frame_slice(
  table_set STRING,
  relevant_slice_table_name STRING
)
RETURNS STRING AS
