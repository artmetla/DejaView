...
INCLUDE DEJAVIEW MODULE android.memory.heap_graph.excluded_refs;
INCLUDE DEJAVIEW MODULE android.memory.heap_graph.helpers;
...
CREATE DEJAVIEW TABLE _heap_graph_object_min_depth_tree AS
...
CREATE DEJAVIEW TABLE _heap_graph_path_hashes as
SELECT *
FROM _heap_graph_type_path_hash!(_heap_graph_object_min_depth_tree);

CREATE DEJAVIEW TABLE _heap_graph_path_hashes_aggregated as
SELECT *
FROM _heap_graph_path_hash_aggregate!(_heap_graph_path_hashes);

CREATE DEJAVIEW TABLE _heap_graph_class_tree AS
SELECT *
