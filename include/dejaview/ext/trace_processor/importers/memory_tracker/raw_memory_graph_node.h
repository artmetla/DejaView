...
#ifndef INCLUDE_DEJAVIEW_EXT_TRACE_PROCESSOR_IMPORTERS_MEMORY_TRACKER_RAW_MEMORY_GRAPH_NODE_H_
#define INCLUDE_DEJAVIEW_EXT_TRACE_PROCESSOR_IMPORTERS_MEMORY_TRACKER_RAW_MEMORY_GRAPH_NODE_H_
...
class DEJAVIEW_EXPORT_COMPONENT RawMemoryGraphNode {
 public:
  enum Flags {
    kDefault = 0,
  ...
  // exist).
  struct DEJAVIEW_EXPORT_COMPONENT MemoryNodeEntry {
    enum EntryType {
      kUint64,
      kString,
    };
...
#endif  // INCLUDE_DEJAVIEW_EXT_TRACE_PROCESSOR_IMPORTERS_MEMORY_TRACKER_RAW_MEMORY_GRAPH_NODE_H_
