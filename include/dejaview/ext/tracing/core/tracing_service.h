...
#ifndef INCLUDE_DEJAVIEW_EXT_TRACING_CORE_TRACING_SERVICE_H_
#define INCLUDE_DEJAVIEW_EXT_TRACING_CORE_TRACING_SERVICE_H_
...
class DEJAVIEW_EXPORT_COMPONENT ProducerEndpoint {
 public:
...
//    the service don't talk locally but via some IPC mechanism.
class DEJAVIEW_EXPORT_COMPONENT ConsumerEndpoint {
 public:
...
struct DEJAVIEW_EXPORT_COMPONENT TracingServiceInitOpts {
...
class DEJAVIEW_EXPORT_COMPONENT RelayEndpoint {
 public:
...
class DEJAVIEW_EXPORT_COMPONENT TracingService {
 public:
  using ProducerEndpoint = dejaview::ProducerEndpoint;
  using ConsumerEndpoint = dejaview::ConsumerEndpoint;
  using RelayEndpoint = dejaview::RelayEndpoint;
...
#endif  // INCLUDE_DEJAVIEW_EXT_TRACING_CORE_TRACING_SERVICE_H_
