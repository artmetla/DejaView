...
CREATE DEJAVIEW TABLE chrome_janky_event_latencies_v3(
  -- The slice id.
  id INT,
...
CREATE DEJAVIEW VIEW chrome_janky_frame_presentation_intervals(
  -- Unique id.
  id INT,
  -- The start timestamp of the slice.
  ts INT,
...
CREATE DEJAVIEW TABLE chrome_scroll_stats(
...
CREATE DEJAVIEW TABLE chrome_scroll_jank_intervals_v3(
