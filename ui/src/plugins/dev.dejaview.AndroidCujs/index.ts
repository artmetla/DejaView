...
class AndroidCujs implements DejaViewPlugin {
  async onTraceLoad(ctx: Trace): Promise<void> {
    ctx.commands.registerCommand({
      id: 'dev.dejaview.AndroidCujs#PinJankCUJs',
    ...
    ctx.commands.registerCommand({
      id: 'dev.dejaview.AndroidCujs#ListJankCUJs',
    ...
    ctx.commands.registerCommand({
      id: 'dev.dejaview.AndroidCujs#PinLatencyCUJs',
    ...
    ctx.commands.registerCommand({
      id: 'dev.dejaview.AndroidCujs#ListLatencyCUJs',
    ...
    ctx.commands.registerCommand({
      id: 'dev.dejaview.AndroidCujs#PinBlockingCalls',
...
export const plugin: PluginDescriptor = {
  pluginId: 'dev.dejaview.AndroidCujs',
  plugin: AndroidCujs,
};
