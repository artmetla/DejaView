...
from dejaview.trace_processor.platform import PlatformDelegate
...
class ProtoFactory:
  ...
  def __init__(self, platform_delegate: PlatformDelegate):
    ...
    self.AppendTraceDataResult = create_message_factory(
        'dejaview.protos.AppendTraceDataResult')
    self.StatusResult = create_message_factory('dejaview.protos.StatusResult')
    self.ComputeMetricArgs = create_message_factory(
        'dejaview.protos.ComputeMetricArgs')
    self.ComputeMetricResult = create_message_factory(
        'dejaview.protos.ComputeMetricResult')
    self.QueryArgs = create_message_factory('dejaview.protos.QueryArgs')
    self.QueryResult = create_message_factory('dejaview.protos.QueryResult')
    self.TraceMetrics = create_message_factory('dejaview.protos.TraceMetrics')
    self.DisableAndReadMetatraceResult = create_message_factory(
        'dejaview.protos.DisableAndReadMetatraceResult')
    self.CellsBatch = create_message_factory(
        'dejaview.protos.QueryResult.CellsBatch')
