...
#ifndef INCLUDE_DEJAVIEW_EXT_IPC_SERVICE_PROXY_H_
#define INCLUDE_DEJAVIEW_EXT_IPC_SERVICE_PROXY_H_
...
class DEJAVIEW_EXPORT_COMPONENT ServiceProxy {
 public:
  class EventListener {
   public:
...
#endif  // INCLUDE_DEJAVIEW_EXT_IPC_SERVICE_PROXY_H_
