...
#ifndef INCLUDE_DEJAVIEW_TRACING_INTERNAL_TRACK_EVENT_LEGACY_H_
#define INCLUDE_DEJAVIEW_TRACING_INTERNAL_TRACK_EVENT_LEGACY_H_
...
enum DejaViewLegacyCurrentThreadId { kCurrentThreadId };
...
#define TRACE_EVENT_API_CURRENT_THREAD_ID ::dejaview::legacy::kCurrentThreadId
...
class DEJAVIEW_EXPORT_COMPONENT LegacyTraceId {
 public:
...
class DEJAVIEW_EXPORT_COMPONENT TrackEventLegacy {
 public:
  ...
  static void WriteLegacyEvent(EventContext ctx,
                               char phase,
                               uint32_t flags,
                               Args&&... args) DEJAVIEW_NO_INLINE {
    DEJAVIEW_DCHECK(!(flags & TRACE_EVENT_FLAG_HAS_PROCESS_ID));
  ...
  static void WriteLegacyEventWithIdAndTid(EventContext ctx,
    ...
    //
    DEJAVIEW_DCHECK(PhaseToType(phase) ==
                        protos::pbzero::TrackEvent::TYPE_UNSPECIFIED ||
...
#endif  // INCLUDE_DEJAVIEW_TRACING_INTERNAL_TRACK_EVENT_LEGACY_H_
