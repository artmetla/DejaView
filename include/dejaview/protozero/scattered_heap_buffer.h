...
#ifndef INCLUDE_DEJAVIEW_PROTOZERO_SCATTERED_HEAP_BUFFER_H_
#define INCLUDE_DEJAVIEW_PROTOZERO_SCATTERED_HEAP_BUFFER_H_
...
class DEJAVIEW_EXPORT_COMPONENT ScatteredHeapBuffer
    : public protozero::ScatteredStreamWriter::Delegate {
 public:
  class DEJAVIEW_EXPORT_COMPONENT Slice {
   public:
    Slice();
    ...
    void set_unused_bytes(size_t unused_bytes) {
      DEJAVIEW_DCHECK(unused_bytes_ <= size_);
...
#endif  // INCLUDE_DEJAVIEW_PROTOZERO_SCATTERED_HEAP_BUFFER_H_
