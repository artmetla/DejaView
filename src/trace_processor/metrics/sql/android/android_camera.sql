...
CREATE DEJAVIEW VIEW rss_gca AS
...
CREATE DEJAVIEW VIEW rss_camera_hal AS
...
CREATE DEJAVIEW VIEW rss_cameraserver AS
...
CREATE DEJAVIEW VIEW rss_and_dma_all_camera_span AS
SELECT
  ts,
  dur,
...
CREATE DEJAVIEW VIEW rss_and_dma_all_camera_stats AS
SELECT
...
CREATE DEJAVIEW VIEW android_camera_event AS
SELECT
...
CREATE DEJAVIEW VIEW android_camera_output AS
SELECT
  AndroidCameraMetric(
