...
#ifndef INCLUDE_DEJAVIEW_EXT_BASE_SCOPED_FILE_H_
#define INCLUDE_DEJAVIEW_EXT_BASE_SCOPED_FILE_H_
...
int DEJAVIEW_EXPORT_COMPONENT CloseFile(int fd);
...
#endif  // INCLUDE_DEJAVIEW_EXT_BASE_SCOPED_FILE_H_
